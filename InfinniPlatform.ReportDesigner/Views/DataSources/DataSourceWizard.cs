...
namespace InfinniPlatform.ReportDesigner.Views.DataSources
{
	...
	sealed class DataSourceWizard
	{
		...
		private bool OnMsSqlTableSelected()
		{
			...
			{
				_msSqlTableSelectView.AsyncLoadDataSourceInfo(_wizardView, dataSourceInfo => _msSqlDataSourceView.DataSourceInfo = dataSourceInfo);
		...
		private bool OnFirebirdTableSelected()
		{
			...
			{
				_firebirdTableSelectView.AsyncLoadDataSourceInfo(_wizardView, dataSourceInfo => _firebirdDataSourceView.DataSourceInfo = dataSourceInfo);
