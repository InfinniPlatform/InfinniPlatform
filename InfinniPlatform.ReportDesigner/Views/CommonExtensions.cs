...
namespace InfinniPlatform.ReportDesigner.Views
{
    internal static class CommonExtensions
    {
        ...
        {
            MessageBox.Show(string.Format(message, args), Resources.ReportDesignerName, MessageBoxButtons.OK,
        ...
        {
            return
                MessageBox.Show(string.Format(message, args), Resources.ReportDesignerName, MessageBoxButtons.YesNo,
                    MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.Yes;
        }

        public static DialogResult ShowQuestionWithCancel(this string message, params object[] args)
        {
            return MessageBox.Show(string.Format(message, args), Resources.ReportDesignerName,
                MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button3);
        }

        public static void AsyncAction<TResult>(this Control control, Func<TResult> work, Action<TResult> success = null,
            Action error = null)
        {
            var worker = new BackgroundWorker();

            worker.DoWork += (s, e) => { e.Result = work(); };
