...
namespace InfinniPlatform.Utils.Exchange
{
	...
	{
		readonly IList<SourceAssemblyInfo> _sourceAssemblyList = new List<SourceAssemblyInfo>();
		...
		void LoadSourceAssembliesForConfig(string version, string configurationId)
		{
