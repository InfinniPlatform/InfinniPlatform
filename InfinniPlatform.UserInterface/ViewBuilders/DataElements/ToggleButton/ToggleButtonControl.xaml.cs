...
namespace InfinniPlatform.UserInterface.ViewBuilders.DataElements.ToggleButton
{
	...
	sealed partial class ToggleButtonControl : UserControl
	{
		...
		public static readonly DependencyProperty TextOnProperty = DependencyProperty.Register("TextOn", typeof(string), typeof(ToggleButtonControl), new FrameworkPropertyMetadata(Properties.Resources.ToggleButtonControlTextOn));
		...
		public static readonly DependencyProperty TextOffProperty = DependencyProperty.Register("TextOff", typeof(string), typeof(ToggleButtonControl), new FrameworkPropertyMetadata(Properties.Resources.ToggleButtonControlTextOff));
		...
		public static readonly DependencyProperty IsReadOnlyProperty = DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(ToggleButtonControl), new FrameworkPropertyMetadata(false));
		...
		public static readonly DependencyProperty EditValueProperty = DependencyProperty.Register("EditValue", typeof(object), typeof(ToggleButtonControl), new FrameworkPropertyMetadata(null, OnEditValueChangedHandler));
		...
		public static readonly RoutedEvent OnEditValueChangedEvent = EventManager.RegisterRoutedEvent("OnEditValueChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ToggleButtonControl));
