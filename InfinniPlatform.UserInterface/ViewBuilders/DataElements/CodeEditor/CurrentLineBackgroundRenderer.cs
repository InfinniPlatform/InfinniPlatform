...
namespace InfinniPlatform.UserInterface.ViewBuilders.DataElements.CodeEditor
{
	...
	/// </summary>
	sealed class CurrentLineBackgroundRenderer : IBackgroundRenderer
	{
		...
		public void Draw(TextView textView, DrawingContext drawingContext)
		{
			if (_editor.Document != null)
			{
				...
				{
					drawingContext.DrawRectangle(null, CurrentLinePen, new Rect(rect.Location, new Size(lineWidth, rect.Height)));
				}
			}
		}
