...
namespace InfinniPlatform.UserInterface.ViewBuilders.DataElements.DataNavigation
{
	...
	sealed partial class DataNavigationControl : UserControl
	{
		...
		public static readonly RoutedEvent OnUpdateItemsEvent = EventManager.RegisterRoutedEvent("OnUpdateItems", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DataNavigationControl));
		...
		public static readonly DependencyProperty PageCountProperty = DependencyProperty.Register("PageCount", typeof(int?), typeof(DataNavigationControl), new FrameworkPropertyMetadata(null, OnPageCountChanged, OnCoercePageCount));
		public static readonly RoutedEvent OnSetPageCountEvent = EventManager.RegisterRoutedEvent("OnSetPageCount", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DataNavigationControl));
		...
		public static readonly DependencyProperty PageNumberProperty = DependencyProperty.Register("PageNumber", typeof(int), typeof(DataNavigationControl), new FrameworkPropertyMetadata(0, OnPageNumberChanged, OnCoercePageNumber));
		public static readonly RoutedEvent OnSetPageNumberEvent = EventManager.RegisterRoutedEvent("OnSetPageNumber", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DataNavigationControl));
		...
		public static readonly DependencyProperty PageSizeProperty = DependencyProperty.Register("PageSize", typeof(int?), typeof(DataNavigationControl), new FrameworkPropertyMetadata(null, OnPageSizeChanged, OnCoercePageSize));
		public static readonly RoutedEvent OnSetPageSizeEvent = EventManager.RegisterRoutedEvent("OnSetPageSize", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DataNavigationControl));
		...
		public static readonly DependencyProperty AvailablePageSizesProperty = DependencyProperty.Register("AvailablePageSizes", typeof(int[]), typeof(DataNavigationControl), new FrameworkPropertyMetadata(null, OnAvailablePageSizesChanged, OnCoerceAvailablePageSizes));
		public static readonly RoutedEvent OnSetAvailablePageSizesEvent = EventManager.RegisterRoutedEvent("OnSetAvailablePageSizes", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DataNavigationControl));
		...
		private static object OnCoerceAvailablePageSizes(DependencyObject d, object value)
		{
			...
			if (control != null)
			{
				...
				value = (availablePageSizes != null) ? availablePageSizes.Where(i => i > 0).OrderBy(i => i).ToArray() : null;
			}
