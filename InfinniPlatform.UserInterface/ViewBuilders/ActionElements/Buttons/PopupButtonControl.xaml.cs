...
namespace InfinniPlatform.UserInterface.ViewBuilders.ActionElements.Buttons
{
	...
	sealed partial class PopupButtonControl : PopupBaseEdit
	{
		...
		public static readonly DependencyProperty ImageProperty = DependencyProperty.Register("Image", typeof(ImageSource), typeof(PopupButtonControl), new FrameworkPropertyMetadata(null, OnButtonImage));
