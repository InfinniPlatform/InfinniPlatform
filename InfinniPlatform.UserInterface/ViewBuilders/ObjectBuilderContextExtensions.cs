...
{
	static class ObjectBuilderContextExtensions
	{
		...
		public static IEnumerable BuildParameters(this ObjectBuilderContext context, View parentView, dynamic metadataValue)
		{
			return context.BuildMany(parentView, "Parameter", metadataValue);
		}

		public static IEnumerable BuildTabPages(this ObjectBuilderContext context, View parentView, dynamic metadataValue)
		{
			return context.BuildMany(parentView, "TabPage", metadataValue);
		}

		public static IElementDataBinding BuildOneWayBinding(this ObjectBuilderContext context, View parentView, object element, string elementProperty, dynamic bindingMetadata)
		{
			...
			{
				propertyBinding.OnPropertyValueChanged += (c, a) => element.InvokeMember(setPropertyMethod, new object[] { a.Value }, out setPropertyResult);
			}
			else
			{
