...
{
	sealed class ViewBuilder : IObjectBuilder
	{
		...
		private static void OnClosingDefaultHandler(View view, dynamic arguments)
		{
			arguments.IsCancel = (arguments.Force != true)
								 ...
								 && MessageBox.Show(Resources.CloseViewQuestion, view.GetText(), MessageBoxButton.YesNo, MessageBoxImage.Warning) == MessageBoxResult.No;
		}
	}
}