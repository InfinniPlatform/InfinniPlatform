...
namespace InfinniPlatform.UserInterface.ViewBuilders.Views
{
	static class ViewExtensions
	{
		...
		/// </summary>
		public static void NotifyWhenEventAsync(this View source, Expression<Func<View, ScriptDelegate>> sourceEvent, Func<dynamic, bool> initArguments = null)
		{
		...
		/// Оповещает шину сообщений асинхронно, когда у источника происходит указанное событие.
		/// </summary>
		public static void NotifyWhenEventAsync<T>(this T source, Expression<Func<T, ScriptDelegate>> sourceEvent, Func<dynamic, bool> initArguments = null) where T : IViewChild
		{
			var sourceEventName = (sourceEvent != null) ? sourceEvent.Body.ToString().Split('.').LastOrDefault() : null;
		...
		private static void NotifyWhenEvent(bool async, object source, string sourceEvent, Func<dynamic, bool> initArguments, Func<IMessageExchange> exchangeFunc)
		{
			...
			{
				throw new ArgumentNullException("sourceEvent", string.Format(Resources.SourceHasNoEvent, sourceType.Name, sourceEvent));
			}
		...
		/// </summary>
		public static void SubscribeOnEvent(this View receiver, Action<View, dynamic> eventHandler, Func<dynamic, bool> filterByArguments = null)
		{
		...
		/// Подписывает получателя на указанное сообщение от шины сообщений.
		/// </summary>
		public static void SubscribeOnEvent<T>(this T receiver, Action<T, dynamic> eventHandler, Func<dynamic, bool> filterByArguments = null) where T : IViewChild
		{
			// Warning: Magic!
			var eventName = (eventHandler != null) ? eventHandler.Method.Name : null;

			SubscribeOnEvent(receiver, eventName, eventHandler, filterByArguments, () => receiver.GetView().GetExchange());
		}

		/// <summary>
		/// Подписывает получателя на указанное сообщение от шины сообщений.
		/// </summary>
		public static void SubscribeOnEvent<T>(this T receiver, string eventName, Action<T, dynamic> eventHandler, Func<dynamic, bool> filterByArguments = null) where T : IViewChild
		{
			SubscribeOnEvent(receiver, eventName, eventHandler, filterByArguments, () => receiver.GetView().GetExchange());
		}

		private static void SubscribeOnEvent<T>(T receiver, string eventName, Action<T, dynamic> eventHandler, Func<dynamic, bool> filterByArguments, Func<IMessageExchange> exchangeFunc)
		{
