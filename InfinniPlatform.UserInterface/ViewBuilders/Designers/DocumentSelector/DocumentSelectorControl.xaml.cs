...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.DocumentSelector
{
    public partial class DocumentSelectorControl : UserControl
    {
        ...
        public static readonly RoutedEvent RefreshClickEvent = EventManager.RegisterRoutedEvent("RefreshClick",
            RoutingStrategy.Bubble, typeof (RoutedEventHandler), typeof (DocumentSelectorControl));

        // EditValueChanged

        public static readonly RoutedEvent EditValueChangedEvent = EventManager.RegisterRoutedEvent("EditValueChanged",
            RoutingStrategy.Bubble, typeof (ValueChangedRoutedEventHandler), typeof (DocumentSelectorControl));
