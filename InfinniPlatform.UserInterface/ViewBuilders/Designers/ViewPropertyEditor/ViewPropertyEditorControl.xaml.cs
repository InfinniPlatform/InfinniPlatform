...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.ViewPropertyEditor
{
    public sealed partial class ViewPropertyEditorControl : UserControl
    {
        ...
        private Func<PropertyEditorItem, bool> InsertCollectionProperty(ICollection<PropertyEditorItem> propertyItems,
        ...
        private Func<PropertyEditorItem, PropertyEditorItem, bool> UpdateCollectionProperty(
            ICollection<PropertyEditorItem> propertyItems, PropertyEditor propertyEditor)
        {
                    ...
                    if (oldPropertyValue != null && newPropertyValue != null)
                    {
                        ...
                        if (editValue != null)
                        {
                            ...
                            if (collection != null)
                            {
                                ...
                                ProcessCollection(collection, propertyEditor, oldPropertyValue,
                                    item => collection.ReplaceItem(item, wrapNewPropertyValue));
                            }
        ...
        private Func<PropertyEditorItem, PropertyEditorItem, bool> UpdateScalarProperty(
            ICollection<PropertyEditorItem> propertyItems, PropertyEditor propertyEditor)
        {
            return (oldPropertyItem, newPropertyItem) =>
            {
        ...
        private void OnDeletePropertyHandler(object sender, RoutedEventArgs e)
        {
            ...
            if (propertyItem != null &&
                AcceptQuestion(Properties.Resources.PropertyEditorControlDeletePropertyQuestion, propertyItem.Name))
            {
        ...
        private Func<PropertyEditorItem, bool> DeleteCollectionProperty(ICollection<PropertyEditorItem> propertyItems,
            PropertyEditor propertyEditor)
        {
            return propertyItem =>
            {
        ...
        private Func<PropertyEditorItem, bool> DeleteScalarProperty(ICollection<PropertyEditorItem> propertyItems,
            PropertyEditor propertyEditor)
        {
            return propertyItem =>
            {
        ...
        private static void ProcessCollection(IList collection, PropertyEditor propertyEditor, dynamic propertyValue,
        ...
        {
            return
                MessageBox.Show(string.Format(message, args), Properties.Resources.PropertyEditorControlCaption,
        ...
        public static readonly DependencyProperty PropertyEditorsProperty =
            DependencyProperty.Register("PropertyEditors", typeof (IEnumerable<PropertyEditor>),
                typeof (ViewPropertyEditorControl), new FrameworkPropertyMetadata(null, OnPropertyEditorsChangedHandler));

        // EditValue

        public static readonly DependencyProperty EditValueProperty = DependencyProperty.Register("EditValue",
            typeof (object), typeof (ViewPropertyEditorControl),
        ...
        public static readonly RoutedEvent EditValueChangedEvent = EventManager.RegisterRoutedEvent("EditValueChanged",
            RoutingStrategy.Bubble, typeof (ValueChangedRoutedEventHandler), typeof (ViewPropertyEditorControl));
    }
}