...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.StatusDesigner
{
    /// <summary>
    ///     Элемент представления для редактирования статусов.
    /// </summary>
    internal sealed class StatusDesignerElement : BaseElement<StatusDesignerControl>
    {
        public StatusDesignerElement(View view)
            : base(view)
        {
