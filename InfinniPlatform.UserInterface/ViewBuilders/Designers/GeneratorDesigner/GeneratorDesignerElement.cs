...
{
    /// <summary>
    ///     Элемент представления для редактирования генераторов.
    /// </summary>
    internal sealed class GeneratorDesignerElement : BaseElement<GeneratorDesignerControl>
    {
        public GeneratorDesignerElement(View view)
            : base(view)
        {
