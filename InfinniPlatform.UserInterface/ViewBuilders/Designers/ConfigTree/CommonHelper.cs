...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.ConfigTree
{
	static class CommonHelper
	{
		...
		{
			MessageBox.Show(string.Format(message, args), Resources.AppViewText, MessageBoxButton.OK, MessageBoxImage.Error);
		}

		public static void ShowWarningMessage(string message, params object[] args)
		{
			MessageBox.Show(string.Format(message, args), Resources.AppViewText, MessageBoxButton.OK, MessageBoxImage.Warning);
		}

		public static bool AcceptQuestionMessage(string message, params object[] args)
		{
			return MessageBox.Show(string.Format(message, args), Resources.AppViewText, MessageBoxButton.YesNo, MessageBoxImage.Question, MessageBoxResult.No) == MessageBoxResult.Yes;
		}
	}
}