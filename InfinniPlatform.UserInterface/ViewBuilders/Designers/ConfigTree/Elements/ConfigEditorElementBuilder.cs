...
{
    internal sealed class ConfigEditorElementBuilder : IObjectBuilder
    {
        ...
        private static LinkView CreateEditorView(ObjectBuilderContext context, View parent, string elementType,
