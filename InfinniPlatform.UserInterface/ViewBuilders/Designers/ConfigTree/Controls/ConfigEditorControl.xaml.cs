...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.ConfigTree.Controls
{
	...
	public sealed partial class ConfigEditorControl : UserControl
	{
		...
		public static readonly DependencyProperty EditPanelProperty = DependencyProperty.Register("EditPanel", typeof(IConfigElementEditPanel), typeof(ConfigEditorControl), new PropertyMetadata(OnEditPanelChanged));
