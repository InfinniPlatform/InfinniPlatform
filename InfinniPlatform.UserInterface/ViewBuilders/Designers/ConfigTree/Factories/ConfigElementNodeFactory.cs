...
{
	sealed class ConfigElementNodeFactory : IConfigElementNodeFactory
	{
		...
		public void Create(ConfigElementNodeBuilder builder, ICollection<ConfigElementNode> elements, ConfigElementNode elementNode)
		{
			...
			builder.BuildElement(elements, elementNode, elementNode.ElementMetadata, AssemblyContainerNodeFactory.ElementType);
