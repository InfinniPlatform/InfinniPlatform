...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.ConfigTree.Commands
{
    internal sealed class ReconnectCommand : CommandBase<object>
    {
        ...
        private void Reconnect(dynamic connectionSettings)
        {
            ...
            HostingConfig.Default.ServerName = CastToString(connectionSettings.ServerName,
                HostingConfig.Default.DefaultServerName);
            HostingConfig.Default.ServerPort = CastToInt(connectionSettings.ServerPort,
                HostingConfig.Default.DefaultServerPort);
