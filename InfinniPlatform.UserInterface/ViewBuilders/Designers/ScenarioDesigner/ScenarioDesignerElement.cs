...
{
    /// <summary>
    ///     Элемент представления для редактирования сценариев.
    /// </summary>
    internal sealed class ScenarioDesignerElement : BaseElement<ScenarioDesignerControl>
    {
        public ScenarioDesignerElement(View view)
            : base(view)
        {
