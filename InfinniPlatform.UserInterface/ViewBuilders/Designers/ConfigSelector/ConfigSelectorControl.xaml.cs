...
namespace InfinniPlatform.UserInterface.ViewBuilders.Designers.ConfigSelector
{
	public partial class ConfigSelectorControl : UserControl
	{
		...
		public static readonly RoutedEvent RefreshClickEvent = EventManager.RegisterRoutedEvent("RefreshClick", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ConfigSelectorControl));
		...
		public static readonly RoutedEvent EditValueChangedEvent = EventManager.RegisterRoutedEvent("EditValueChanged", RoutingStrategy.Bubble, typeof(ValueChangedRoutedEventHandler), typeof(ConfigSelectorControl));
