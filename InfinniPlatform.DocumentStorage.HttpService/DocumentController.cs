...
namespace InfinniPlatform.DocumentStorage
{
    ...
    //{
    //    public DocumentController(IDocumentHttpServiceHandlerBase serviceHandler,
    ...
    //                              IPerformanceLogger<DocumentController> perfLogger,
    ...
    //    {
    //        return ProcessRequestAsync((r, rd) => _queryFactory.CreateGetQuery(r,rd),
    //                                   async query =>
    //                                   {
    //                                       // Установка фильтра
    ...
    //    {
    //        return ProcessRequestAsync((r, rd) => _queryFactory.CreatePostQuery(r, rd),
    //                                   async query =>
    //                                   {
    ...
    //    {
    //        return ProcessRequestAsync((r, rd) => _queryFactory.CreateDeleteQuery(r, rd),
    //                                   async query =>
    //                                   {
    ...
    /// Сервис по работе с документами на базе <see cref="IDocumentStorage{TDocument}"/>.
    /// </summary>
    public class DocumentController<TDocument> : DocumentControllerBase where TDocument : Document
    {
        public DocumentController(IDocumentHttpServiceHandlerBase serviceHandler,
