...
namespace InfinniPlatform.Core.ModelRepository.DataConverters
{
    /// <summary>
    ...
    public interface IDataConverter
    {
        ...
        /// <returns>
        ///     Результат конвертации, если true - конвертация
        ///     завершилась успешно, false - нет (ошибки содержатся в поле errorMessage)
        /// </returns>
        bool ConvertData(
            Stream sourceData,
