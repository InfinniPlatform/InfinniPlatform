...
namespace InfinniPlatform.Json
{
	...
	{
		private readonly Dictionary<Func<string,bool>, Func<string,IJsonTokenProvider>> _builders = new Dictionary<Func<string, bool>, Func<string, IJsonTokenProvider>>();
		private Func<string, IJsonTokenProvider> _defaultProvider;

		public JsonTokenConfiguration BuilderFor(Func<string,bool> conditionFunc, Func<string,IJsonTokenProvider> jsonTokenProvider)
		{
