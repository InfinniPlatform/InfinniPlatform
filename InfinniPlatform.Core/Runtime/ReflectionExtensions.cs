...
namespace InfinniPlatform.Runtime
{
    public static class ReflectionExtensions
    {
        ...
        public static IEnumerable<MethodInfo> FindMethodInfo(IEnumerable<Assembly> assemblies, string type,
            string method)
        {
            ...
            foreach (var assembly in assemblies)
            {
                foreach (var assemblyType in assembly.GetTypes())
                {
                    ...
                    {
                        var methods =
                            assemblyType.GetMethods(BindingFlags.FlattenHierarchy | BindingFlags.Public |
