...
namespace InfinniPlatform.Runtime
{
	...
	{
		public static IEnumerable<MethodInfo> GetProcessedMethods(this Assembly assembly, IEnumerable<string> processedMethods )
		{
		...
		{			
			...
			foreach (var methodInfo in methodInfoList)
			{
				...
				dynamic info = new DynamicInstance();
				info.TypeName = methodInfo.DeclaringType.Name;
