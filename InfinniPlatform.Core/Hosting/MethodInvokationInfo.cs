...
namespace InfinniPlatform.Hosting
{
	public class MethodInvokationInfo
	{
		...
		public MethodInvokationInfo(MethodInfo methodInfo, IQueryHandler target, VerbType verbType, IEnumerable<string> serviceNames)
		{
		...
		public TargetDelegate ConstructDelegate(IDictionary<string, object> verbArguments, object instance, HttpResultHandlerType httpResultHandler)
		{
