...
namespace InfinniPlatform.Core.Deprecated
{
    public static class MetadataBuilderExtensions
    {
        ...
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Id = id; });
            return buildObject;
        }

        public static object BuildText(this object buildObject, string text)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Text = text; });
            return buildObject;
        }

        public static object BuildName(this object buildObject, string name)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Name = name; });
            return buildObject;
        }

        public static object BuildCaption(this object buildObject, string caption)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Caption = caption; });
            return buildObject;
        }

        public static object BuildDescription(this object buildObject, string description)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Description = description; });
            return buildObject;
        }

        public static object BuildVersion(this object buildObject, string version)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.Version = version; });
            return buildObject;
        }
        ...
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.CanClose = false; });
            return buildObject;
        }
        ...
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.KeyProperty = propertyName; });
            return buildObject;
        }

        public static object BuildTreeViewParentProperty(this object buildObject, string propertyName)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.ParentProperty = propertyName; });
            return buildObject;
        }

        public static object BuildTreeViewDisplayProperty(this object buildObject, string propertyName)
        {
            buildObject.InvokeDynamicOperation(dynamicObject => { dynamicObject.DisplayProperty = propertyName; });
            return buildObject;
        }
