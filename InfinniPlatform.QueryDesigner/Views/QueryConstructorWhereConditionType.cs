...
namespace InfinniPlatform.QueryDesigner.Views
{
	public partial class QueryConstructorWhereConditionType : UserControl
	{
		public QueryConstructorWhereConditionType()
		{
			...
			ComboBoxConditionType.Properties.Items.Add(new ImageComboBoxItem("IsNotStartsWith", CriteriaType.IsNotStartsWith));
			...
			ComboBoxConditionType.Properties.Items.Add(new ImageComboBoxItem("IsLessThanOrEquals", CriteriaType.IsLessThanOrEquals));
			ComboBoxConditionType.Properties.Items.Add(new ImageComboBoxItem("IsMoreThan", CriteriaType.IsMoreThan));
			ComboBoxConditionType.Properties.Items.Add(new ImageComboBoxItem("IsMoreThanOrEquals", CriteriaType.IsMoreThanOrEquals));			
		}
