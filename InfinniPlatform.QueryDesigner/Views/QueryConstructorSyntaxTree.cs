...
namespace InfinniPlatform.QueryDesigner.Views
{
	public partial class QueryConstructorSyntaxTree : UserControl, IInitializedOnLoad
	{
		...
		private readonly Dictionary<NavBarItemLink, Control> _associatedControls = new Dictionary<NavBarItemLink, Control>(); 
		...
		private void ButtonAddJoinClick(object sender, EventArgs e)
		{
			...
			itemlink.Item.SmallImage = Properties.Resources.delete_16x16;
		...
		private void NavBarSyntax_MouseDown(object sender, MouseEventArgs e)
		{
			if (e.Button == MouseButtons.Left)
			{
				...
				{
					if (MessageBox.Show(string.Format("Please, confirm delete section \"{0}\"", hitInfo.Link.Item.Name), "Confirm needed",
