...
namespace InfinniPlatform.Metadata.StateMachine.Statuses
{
	...
	public class StateWorkflowStartingPointConfig : IStateWorkflowStartingPointConfig
	{
		...
		public IStateWorkflowStartingPointConfig ForState(object status, Action<IStateWorkflowConfig> workflowConfigInitializer = null)
		{
			if (status == null)
			{
		...
		/// <returns></returns>
		public IStateWorkflowStartingPointConfig FlowWithoutState(Action<IStateWorkflowConfig> workflowConfigInitializer = null)
		{
