...
namespace InfinniPlatform.SystemConfig.Administration.Menu
{
    internal static class MenuHelper
    {
        ...
        public static void SetMenuItemRoles(string configId, string menuId, int level, int oldIndex, int newIndex,
            IEnumerable roles)
        {
            // Todo
        }
        ...
        public static dynamic FindMenuItem(string configId, string menuId, int level, int index, string parentId,
            dynamic itemInfo, string itemId)
        {
