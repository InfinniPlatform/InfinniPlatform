    ...
    public sealed class ActionUnitCreateRegisterEntry
    {
        public void Action(IApplyResultContext target)
        {
            ...
            else
            {
                ...
                var defaultProcess =
                    target.Context.GetComponent<IMetadataComponent>()
                          .GetMetadata(null, configuration, documentId, MetadataType.Process, "Default");
                var customProcess =
                    target.Context.GetComponent<IMetadataComponent>()
                          .GetMetadata(null, configuration, documentId, MetadataType.Process, "Custom");
            ...
            var registerMetadata =
                target.Context.GetComponent<IMetadataComponent>()
                      .GetMetadataList(null, configuration, registerId, MetadataType.Register)
                      .FirstOrDefault();
