...
namespace InfinniPlatform.SystemConfig.Configurator
{
    ...
    {
        public ActionUnitGetManagedMetadata(RestQueryApi restQueryApi)
        {
            ...
            if (validator.Validate(target.Item))
            {
                ...
                else
                {
                        ...
                        target.Item.MetadataType.ToLowerInvariant())
                    {
                        ...
                        target.Result = _restQueryApi.QueryPostJsonRaw("SystemConfig", "metadata", "generatemetadata", null, body).ToDynamic();
                        target.Result.Parameters = CreateParametersArray(target.Item.Parameters);
