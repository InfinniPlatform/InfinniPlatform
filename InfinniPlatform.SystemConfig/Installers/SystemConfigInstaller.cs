...
namespace InfinniPlatform.SystemConfig.Installers
{
    internal sealed class SystemConfigInstaller : MetadataConfigurationInstaller
    {
        ...
        protected override void RegisterConfiguration(IMetadataConfiguration metadataConfiguration)
        {
            ...
            actionUnits.RegisterActionUnitDistributedStorage("generatehelpconfiguration", "ActionUnitGenerateHelpConfiguration");
            ...
            actionUnits.RegisterActionUnitDistributedStorage("getstandardextensionpoints", "ActionUnitGetStandardExtensionPoints");
            ...
            {
                var metadataTypeMetadata = string.Format("{0}metadata", metadataType);
