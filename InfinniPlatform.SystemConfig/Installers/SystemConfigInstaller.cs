...
namespace InfinniPlatform.SystemConfig.Installers
{
	public sealed class SystemConfigInstaller : MetadataConfigurationInstaller
	{
		...
		protected override void RegisterConfiguration(IMetadataConfiguration metadataConfiguration)
		{
			...
			//работа с регистрами
			actionUnits.RegisterActionUnitDistributedStorage("GetRegisterValuesByDate", "ActionUnitGetRegisterValuesByDate");
			actionUnits.RegisterActionUnitDistributedStorage("GetRegisterValuesBetweenDates", "ActionUnitGetRegisterValuesBetweenDates");
			actionUnits.RegisterActionUnitDistributedStorage("GetRegisterValuesByRegistrar", "ActionUnitGetRegisterValuesByRegistrar");
			actionUnits.RegisterActionUnitDistributedStorage("GetRegisterValuesByRegistrarType", "ActionUnitGetRegisterValuesByRegistrarType");
			actionUnits.RegisterActionUnitDistributedStorage("GetClosestDateTimeOfTotalCalculation", "ActionUnitGetClosestDateTimeOfTotalCalculation");
			actionUnits.RegisterActionUnitDistributedStorage("RecarryingRegisterEntries", "ActionUnitRecarryingRegisterEntries");
			actionUnits.RegisterActionUnitDistributedStorage("GetRegisterValuesByPeriods", "ActionUnitGetRegisterValuesByPeriods");
			...
			actionUnits.RegisterActionUnitDistributedStorage("checkauthorizationconfig","ActionUnitCheckAuthorizationStorage");
			...
			metadataConfiguration.RegisterWorkflow("prefill", "GetFillItems",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("GetFillItems")))));
			...
			metadataConfiguration.RegisterWorkflow("reporting", "getreport",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("getreport")))));

			metadataConfiguration.RegisterWorkflow("reporting", "getprintview",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("getprintview")))));
			...
			metadataConfiguration.RegisterWorkflow("metadata", "getregisteredconfiglist",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("getregisteredconfiglist")))));

			metadataConfiguration.RegisterWorkflow("metadata", "getconfigurationmetadata",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("getconfigurationmetadata")))));

			metadataConfiguration.RegisterWorkflow("metadata", "GetDocumentElementListMetadata",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("GetDocumentElementListMetadata")))));

			metadataConfiguration.RegisterWorkflow("metadata", "GetDocumentElementMetadata",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("GetDocumentElementMetadata")))));
			...
			metadataConfiguration.RegisterWorkflow("metadata", "GetMenuListMetadata",
				f => f.FlowWithoutState(wc => wc
					.Move(ws => ws
						.WithAction(() => actionUnits.GetAction("GetMenuListMetadata")))));
		...
		protected override void RegisterServices(IServiceRegistrationContainer servicesConfiguration)
		{
			servicesConfiguration.AddRegistration("update", "Upload", reg => reg
				.RegisterHandlerInstance("updateconfigfromjson",
					instance => instance.RegisterExtensionPoint("Upload", "updateconfigfromjson"))
			...
			servicesConfiguration.AddRegistration("reporting", "UrlEncodedData",
				reg => reg.RegisterHandlerInstance("GetReport", instance => instance
					.RegisterExtensionPoint("ProcessUrlEncodedData", "GetReport")).SetResultHandler(HttpResultHandlerType.ByteContent));
			servicesConfiguration.AddRegistration("reporting", "UrlEncodedData",
				reg => reg.RegisterHandlerInstance("GetPrintView", instance => instance
					.RegisterExtensionPoint("ProcessUrlEncodedData", "GetPrintView")).SetResultHandler(HttpResultHandlerType.ByteContent));


			servicesConfiguration.AddRegistration("update", "Search", reg => reg
				.RegisterHandlerInstance("getversionlist",
					instance => instance.RegisterExtensionPoint("SearchModel", "getversionlist")).SetResultHandler(HttpResultHandlerType.BadRequest)
				.RegisterHandlerInstance("getinstalledconfigurations",
					instance => instance.RegisterExtensionPoint("SearchModel", "getinstalledconfigurations")).SetResultHandler(HttpResultHandlerType.BadRequest));
			servicesConfiguration.AddRegistration("metadata", "Search", reg => reg
				.RegisterHandlerInstance("getservicemetadata",
					instance => instance.RegisterExtensionPoint("SearchModel", "getservicemetadata")).SetResultHandler(HttpResultHandlerType.BadRequest)
				.RegisterHandlerInstance("getstandardextensionpoints",
					instance => instance.RegisterExtensionPoint("SearchModel", "getstandardextensionpoints")).SetResultHandler(HttpResultHandlerType.BadRequest));
			servicesConfiguration.AddRegistration("classifier", "ApplyJson", reg => reg
				.RegisterHandlerInstance("getdata",
					instance => instance.RegisterExtensionPoint("GetResult", "GetClassifierList")).SetResultHandler(HttpResultHandlerType.BadRequest));
			...
			servicesConfiguration.AddRegistration("metadata", "ApplyJson", reg => reg
				.RegisterHandlerInstance("RefreshMetadataCache", instance => instance
						.RegisterExtensionPoint("Move", "RefreshMetadataCache")
				).SetResultHandler(HttpResultHandlerType.BadRequest));

            servicesConfiguration.AddRegistration("metadata", "ApplyJson", reg => reg
                .RegisterHandlerInstance("clearcontrollerscache", instance => instance
                        .RegisterExtensionPoint("Move", "clearcontrollerscache")
				).SetResultHandler(HttpResultHandlerType.BadRequest));

			servicesConfiguration.AddRegistration("metadata", "ApplyJson", reg => reg
				.RegisterHandlerInstance("generatehelpconfiguration", instance => instance
					.RegisterExtensionPoint("Move", "generatehelpconfiguration")).SetResultHandler(HttpResultHandlerType.BadRequest));
			...
			servicesConfiguration.AddRegistration("metadata", "ApplyEvents", reg => reg
				.RegisterHandlerInstance("changemetadata", instance => instance
					.RegisterExtensionPoint("FilterEvents", "filtermetadata")
					.RegisterExtensionPoint("Move", "changemetadata")).SetResultHandler(HttpResultHandlerType.BadRequest));

			servicesConfiguration.AddRegistration("metadata", "Aggregation",
				reg => reg.RegisterHandlerInstance("aggregate").SetResultHandler(HttpResultHandlerType.BadRequest));

			servicesConfiguration.AddRegistration("metadata", "ApplyJson", reg => reg
				.RegisterHandlerInstance("deletemetadata", instance => instance
					.RegisterExtensionPoint("FilterEvents", "filtermetadata")
					.RegisterExtensionPoint("Move", "deletemetadata"))
				.RegisterHandlerInstance("GenerateServiceWithoutState", instance => instance
					.RegisterExtensionPoint("Move", "GenerateServiceWithoutState"))
				.RegisterHandlerInstance("CreateGenerator", instance => instance
					.RegisterExtensionPoint("Move", "CreateGenerator"))
				.RegisterHandlerInstance("DeleteGeneratedService", instance => instance
					.RegisterExtensionPoint("Move", "DeleteGeneratedService"))
				.RegisterHandlerInstance("DeleteGenerator", instance => instance
					.RegisterExtensionPoint("Move", "DeleteGenerator"))
				.RegisterHandlerInstance("PostRegisterEntries", instance => instance
					.RegisterExtensionPoint("Move", "PostRegisterEntries"))
				.RegisterHandlerInstance("RecarryingRegisterEntries", instance => instance
					.RegisterExtensionPoint("Move", "RecarryingRegisterEntries"))
				.RegisterHandlerInstance("DeleteRegisterEntry", instance => instance
					.RegisterExtensionPoint("Move", "DeleteRegisterEntry"))
				.RegisterHandlerInstance("getmetadata", instance => instance
					.RegisterExtensionPoint("GetResult", "getmetadata"))
				.RegisterHandlerInstance("getmanagedmetadata", instance => instance
					.RegisterExtensionPoint("Move", "getmanagedmetadata"))
				.RegisterHandlerInstance("getitemid", instance => instance
					.RegisterExtensionPoint("GetResult", "getitemid"))
				.RegisterHandlerInstance("generatemetadata", instance => instance
					.RegisterExtensionPoint("Move", "generatemetadata"))
				.RegisterHandlerInstance("exportdatatojson", instance => instance
					.RegisterExtensionPoint("Move", "exportdatatojson"))
				.RegisterHandlerInstance("importdatafromjson", instance => instance
					.RegisterExtensionPoint("Move", "importdatafromjson"))

				.RegisterHandlerInstance("getregisteredconfiglist",
					instance => instance.RegisterExtensionPoint("GetResult", "getregisteredconfiglist"))
				.RegisterHandlerInstance("getconfigurationmetadata",
					instance => instance.RegisterExtensionPoint("GetResult", "getconfigurationmetadata"))
				.RegisterHandlerInstance("GetDocumentElementListMetadata",
					instance => instance.RegisterExtensionPoint("GetResult", "GetDocumentElementListMetadata"))
				.RegisterHandlerInstance("GetDocumentElementMetadata",
					instance => instance.RegisterExtensionPoint("GetResult", "GetDocumentElementMetadata"))
				.RegisterHandlerInstance("GetDocumentListMetadata",
					instance => instance.RegisterExtensionPoint("GetResult", "GetDocumentListMetadata"))
				.RegisterHandlerInstance("GetDocumentMetadata",
					instance => instance.RegisterExtensionPoint("GetResult", "GetDocumentMetadata"))
				...
				.RegisterHandlerInstance("GetRegisterValuesByDate",
					instance => instance.RegisterExtensionPoint("GetResult", "GetRegisterValuesByDate"))
				.RegisterHandlerInstance("GetRegisterValuesBetweenDates",
					instance => instance.RegisterExtensionPoint("GetResult", "GetRegisterValuesBetweenDates"))
				.RegisterHandlerInstance("GetRegisterValuesByPeriods",
					instance => instance.RegisterExtensionPoint("GetResult", "GetRegisterValuesByPeriods"))
				.RegisterHandlerInstance("GetRegisterValuesByRegistrar",
					instance => instance.RegisterExtensionPoint("GetResult", "GetRegisterValuesByRegistrar"))
				.RegisterHandlerInstance("GetRegisterValuesByRegistrarType",
					instance => instance.RegisterExtensionPoint("GetResult", "GetRegisterValuesByRegistrarType"))
				.RegisterHandlerInstance("GetClosestDateTimeOfTotalCalculation",
					instance => instance.RegisterExtensionPoint("GetResult", "GetClosestDateTimeOfTotalCalculation"))
				.RegisterHandlerInstance("CreateRegisterEntry",
					instance => instance.RegisterExtensionPoint("GetResult", "CreateRegisterEntry"))

				.RegisterHandlerInstance("getmigrations",
					instance => instance.RegisterExtensionPoint("Move", "getmigrations"))
                .RegisterHandlerInstance("getmigrationdetails",
                    instance => instance.RegisterExtensionPoint("Move", "getmigrationdetails"))
				.RegisterHandlerInstance("getverifications",
					instance => instance.RegisterExtensionPoint("Move", "getverifications"))
				.RegisterHandlerInstance("runmigration",
					instance => instance.RegisterExtensionPoint("Move", "runmigration"))
				.RegisterHandlerInstance("revertmigration",
					instance => instance.RegisterExtensionPoint("Move", "revertmigration"))
				.RegisterHandlerInstance("runverification",
					instance => instance.RegisterExtensionPoint("Move", "runverification"))

				.RegisterHandlerInstance("checkauthorizationconfig",
					instance => instance.RegisterExtensionPoint("Move", "checkauthorizationconfig"))
			...
			servicesConfiguration.AddRegistration("prefill", "ApplyJson", reg => reg
				.RegisterHandlerInstance("GetFillItems", instance => instance
					.RegisterExtensionPoint("GetResult", "GetFillItems")).SetResultHandler(HttpResultHandlerType.BadRequest));
