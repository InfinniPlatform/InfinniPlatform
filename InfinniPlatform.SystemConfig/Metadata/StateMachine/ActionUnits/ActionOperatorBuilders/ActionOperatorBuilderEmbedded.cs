...
namespace InfinniPlatform.SystemConfig.Metadata.StateMachine.ActionUnits.ActionOperatorBuilders
{
    public sealed class ActionOperatorBuilderEmbedded : IActionOperatorBuilder
    {
        ...
        public IActionOperator BuildActionOperator()
        {
            ...
            throw new ArgumentException(InfinniPlatform.SystemConfig.Properties.Resources.ActionMethodNotSpecified);
        }
    }
}