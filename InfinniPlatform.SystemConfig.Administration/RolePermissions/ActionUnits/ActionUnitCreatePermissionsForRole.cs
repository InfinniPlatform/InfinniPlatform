		...
		public void Action(IApplyContext target)
		{
			...
			if (sectionFull != null)
			{
				foreach (var docType in sectionFull.DocumentTypeList)
				{
					...
					aclApi.GrantAccess(AuthorizationStorageExtensions.AdminRole, docType.ConfigId, docType.DocumentId, "getdocument");
					...
					aclApi.GrantAccess(AuthorizationStorageExtensions.AdminRole, docType.ConfigId, docType.DocumentId, "setdocument");
					...
					aclApi.GrantAccess(AuthorizationStorageExtensions.AdminRole, docType.ConfigId, docType.DocumentId, "deletedocument");
				}
			}
