    ...
    public sealed class ExpressionExecutorTest
    {
        private static readonly Dictionary<string, object> ObjectCreationExpressionCases
            = new Dictionary<string, object>
            {
                ...
                {
                    "new System.AppDomainSetup() { ApplicationName = \"Application1\" }",
                    new AppDomainSetup {ApplicationName = "Application1"}
                },
                {"new System.Collections.Generic.List<int> { 1, 2, 3 }", new List<int> {1, 2, 3}},
                {
                    "new System.Collections.Generic.Dictionary<int, char> { { 1, 'A' }, { 2, 'B' } }",
        ...
        private static readonly Dictionary<string, Array> ArrayCreationExpressionCases
            = new Dictionary<string, Array>
            {
                ...
                {"new[] { 1, 2, 3 }", new[] {1, 2, 3}},
                {"new[] { 'A', 'b', 'c' }", new[] {'A', 'b', 'c'}},
                {"new[] { \"A\", \"b\", \"c\", null }", new[] {"A", "b", "c", null}},
                {"new[] { 1, 1.5, 'A', \"Abc\", null }", new object[] {1, 1.5, 'A', "Abc", null}},
                {"new[,] { { 1, 2, 3 }, { 4, 5, 6 } }", new[,] {{1, 2, 3}, {4, 5, 6}}},
                {"new[] { new[] { 11 }, new[] { 21, 22 } }", new[] {new[] {11}, new[] {21, 22}}},
                {"new int[]", new int[] {}},
                {"new int[] { }", new int[] {}},
                {"new int[0]", new int[] {}},
                {"new int[0] { }", new int[] {}},
                {"new int[] { 1, 2, 3 }", new[] {1, 2, 3}},
                {"new int[3] { 1, 2, 3 }", new[] {1, 2, 3}},
                {"new int[,] { { 1, 2, 3 }, { 4, 5, 6 } }", new[,] {{1, 2, 3}, {4, 5, 6}}},
                {"new int[2, 3] { { 1, 2, 3 }, { 4, 5, 6 } }", new[,] {{1, 2, 3}, {4, 5, 6}}},
                {"new int[][] { new[] { 11 }, new[] { 21, 22 } }", new[] {new[] {11}, new[] {21, 22}}},
                {"new int[2][] { new[] { 11 }, new[] { 21, 22 } }", new[] {new[] {11}, new[] {21, 22}}},
                {
                ...
                {"new System.Int32[] { 1, 2, 3 }", new[] {1, 2, 3}}
            };

        private static readonly Dictionary<string, object> AnonymousObjectCreationExpressionCases
            = new Dictionary<string, object>
            {
                {"new { Property1 = 1, Property2 = 'A' }", new {Property1 = 1, Property2 = 'A'}},
                {
        ...
        private static readonly Dictionary<string, object> DateTimeFunctionsCases
            = new Dictionary<string, object>
            {
                ...
                {
                    "DateTime.AddMilliseconds(DateTime.Create(2015, 1, 2, 3, 4, 5, 6), 1)",
                    new DateTime(2015, 1, 2, 3, 4, 5, 7)
                },
        ...
        private static readonly Dictionary<string, object> TimeSpanFunctionsCases
            = new Dictionary<string, object>
            {
                ...
                {
                    "TimeSpan.TotalMilliseconds(TimeSpan.Create(1, 2, 3, 4, 5))",
                    new TimeSpan(1, 2, 3, 4, 5).TotalMilliseconds
                },
        ...
        private static readonly Dictionary<string, object> EnumerableFunctionsCases
            = new Dictionary<string, object>
            {
                ...
                {
                    "Enumerable.Equals(new[] { new { Id = 1 }, new { Id = 2 } }, new[] { new { Id = 1 }, new { Id = 2 } }, (x, y) => x.Id == y.Id)",
                    true
                },
                ...
                {
                    "Enumerable.Average(new[] { new { Value = 1 }, new { Value = 2 }, new { Value = 3 } }, i => i.Value)",
                    (1.0 + 2.0 + 3.0)/3.0
                },
                ...
                {
                    "Enumerable.Except(null, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, (x, y) => x.Id == y.Id)",
                    null
                },
                {
                    "Enumerable.Except(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, null, (x, y) => x.Id == y.Id)",
                    new[] {new {Id = 1}, new {Id = 2}, new {Id = 3}}
                },
                {
                    "Enumerable.Except(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, (x, y) => x.Id == y.Id)",
                    new object[] {}
                },
                {
                    "Enumerable.Except(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, new[] { new { Id = 3 }, new { Id = 4 }, new { Id = 5 } }, (x, y) => x.Id == y.Id)",
                ...
                {
                    "Enumerable.Intersect(null, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, (x, y) => x.Id == y.Id)",
                    null
                },
                {
                    "Enumerable.Intersect(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, null, (x, y) => x.Id == y.Id)",
                    null
                },
                {
                    "Enumerable.Intersect(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, (x, y) => x.Id == y.Id)",
                    new[] {new {Id = 1}, new {Id = 2}, new {Id = 3}}
                },
                {
                    "Enumerable.Intersect(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, new[] { new { Id = 3 }, new { Id = 4 }, new { Id = 5 } }, (x, y) => x.Id == y.Id)",
                    new[] {new {Id = 3}}
                },
                ...
                {
                    "Enumerable.Union(new[] { new { Id = 1 } }, new[] { new { Id = 1 } }, (x, y) => x.Id == y.Id)",
                    new[] {new {Id = 1}}
                },
                {
                    "Enumerable.Union(new[] { new { Id = 1 } }, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, (x, y) => x.Id == y.Id)",
                    new[] {new {Id = 1}, new {Id = 2}, new {Id = 3}}
                },
                ...
                {
                    "Enumerable.Select(new[] { 1, 2, 3 }, i => new { Id = i })",
                    new[] {new {Id = 1}, new {Id = 2}, new {Id = 3}}
                },
                {"Enumerable.Select(new[] { 1, 2, 3 }, (i, index) => i * index)", new[] {1*0, 2*1, 3*2}},
                {
                    "Enumerable.Select(new[] { 1, 2, 3 }, (i, index) => new { Id = i * index })",
                    new[] {new {Id = 1*0}, new {Id = 2*1}, new {Id = 3*2}}
                },
                {"Enumerable.SelectMany(null, null)", null},
                {"Enumerable.SelectMany(new[] { new[] { 1 }, new[] { 2 }, new[] { 3 } }, i => i)", new[] {1, 2, 3}},
                {
                    "Enumerable.GroupBy(new[] { new { Id = 1, Value = 'A' }, new { Id = 1, Value = 'B' }, new { Id = 2, Value = 'C' } }, i => i.Id)",
                    new[]
                    {
                        new {Key = 1, Items = new[] {new {Id = 1, Value = 'A'}, new {Id = 1, Value = 'B'}}},
                ...
                {
                    "Enumerable.OrderBy(new[] { new { Id = 3 }, new { Id = 2 }, new { Id = 1 } }, i => i.Id)",
                    new[] {new {Id = 1}, new {Id = 2}, new {Id = 3}}
                },
                ...
                {
                    "Enumerable.OrderByDescending(new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } }, i => i.Id)",
                    new[] {new {Id = 3}, new {Id = 2}, new {Id = 1}}
                },
                {
        ...
        [TestCase("typeof(System.Boolean)", typeof (Boolean))]
        ...
        [TestCase("typeof(System.Single)", typeof (Single))]
        [TestCase("typeof(System.Int32)", typeof (Int32))]
        [TestCase("typeof(System.UInt32)", typeof (UInt32))]
        [TestCase("typeof(System.Int64)", typeof (Int64))]
        [TestCase("typeof(System.UInt64)", typeof (UInt64))]
        [TestCase("typeof(System.Object)", typeof (Object))]
        [TestCase("typeof(System.Int16)", typeof (Int16))]
        [TestCase("typeof(System.UInt16)", typeof (UInt16))]
        ...
        [TestCase("default(System.Boolean)", default(Boolean))]
        ...
        [TestCase("default(System.Single)", default(Single))]
        [TestCase("default(System.Int32)", default(Int32))]
        [TestCase("default(System.UInt32)", default(UInt32))]
        [TestCase("default(System.Int64)", default(Int64))]
        [TestCase("default(System.UInt64)", default(UInt64))]
        [TestCase("default(System.Object)", default(Object))]
        [TestCase("default(System.Int16)", default(Int16))]
        [TestCase("default(System.UInt16)", default(UInt16))]
        ...
        [Test]
        [TestCaseSource("ObjectCreationExpressionCases")]
        ...
        [Test]
        [TestCaseSource("AnonymousObjectCreationExpressionCases")]
        ...
        [TestCase("(System.Int32)null", default(Int32))]
        [TestCase("(bool)null", default(bool))]
        [TestCase("(System.Boolean)null", default(Boolean))]
        ...
        [Test]
        [TestCaseSource("DateTimeFunctionsCases")]
        ...
        [Test]
        [TestCaseSource("TimeSpanFunctionsCases")]
        ...
        [Test]
        [TestCaseSource("EnumerableFunctionsCases")]
