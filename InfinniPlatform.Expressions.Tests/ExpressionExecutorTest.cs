			...
			= new Dictionary<string, Array>
			  {
				  ...
				  { "new[,] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } }", new[,] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } } },
				  { "new int[,][] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } }", new[,] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } } },
				  { "new int[2, 3][] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } }", new[,] { { new[] { 1 }, new[] { 2 }, new[] { 3 } }, { new[] { 4 }, new[] { 5 }, new[] { 6 } } } },
			...
			= new Dictionary<string, object>
			  {
				  ...
				  { "new { Property1 = 1, Property2 = new { SubProperty1 = 1.5 } }", new { Property1 = 1, Property2 = new { SubProperty1 = 1.5 } } }
			  };
			...
			= new Dictionary<string, object>
			  {
				  ...
				  { "Enumerable.GroupBy(new[] { new { Id = 1, Value = 'A' }, new { Id = 1, Value = 'B' }, new { Id = 2, Value = 'C' } }, i => i.Id)", new[] { new { Key = 1, Items = new[] { new { Id = 1, Value = 'A' }, new { Id = 1, Value = 'B' } } }, new { Key = 2, Items = new[] { new { Id = 2, Value = 'C' } } } } },
				  { "Enumerable.GroupBy(new[] { new { Id = 1, Value = 'A' }, new { Id = 1, Value = 'B' }, new { Id = 2, Value = 'C' } }, i => i.Id, i => i.Value)", new[] { new { Key = 1, Items = new[] { 'A', 'B'} }, new { Key = 2, Items = new[] { 'C' } } } },
				  { "Enumerable.GroupBy(new[] { new { Id = 1, Value = 'A' }, new { Id = 1, Value = 'B' }, new { Id = 2, Value = 'C' } }, i => i.Id, i => i.Value, (x, y) => x == y)", new[] { new { Key = 1, Items = new[] { 'A', 'B'} }, new { Key = 2, Items = new[] { 'C' } } } },
				  ...
				  { "Enumerable.OrderByDescending(Enumerable.OrderBy(new[] { new { Key1 = 2, Key2 = 'A' }, new { Key1 = 2, Key2 = 'B' }, new { Key1 = 1, Key2 = 'A' }, new { Key1 = 1, Key2 = 'B' } }, i => i.Key1), i => i.Key2)", new[] { new { Key1 = 1, Key2 = 'B' }, new { Key1 = 1, Key2 = 'A' }, new { Key1 = 2, Key2 = 'B' }, new { Key1 = 2, Key2 = 'A' } } },
