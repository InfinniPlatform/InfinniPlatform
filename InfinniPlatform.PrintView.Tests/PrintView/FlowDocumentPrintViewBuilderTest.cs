...
namespace InfinniPlatform.FlowDocument.Tests.PrintView
{
    ...
    public sealed class FlowDocumentPrintViewBuilderTest
    {
        ...
        private static dynamic CreateTestPrintView()
        {
            ...
            printView.Blocks.Add(CreateSectionWithBorder(new PrintElementThickness(15), new PrintElementThickness(20),
                new PrintElementThickness(4), "Red", "Green",
                CreateSectionWithBorder(new PrintElementThickness(5), new PrintElementThickness(10),
                    new PrintElementThickness(2), "Blue", "Yellow",
