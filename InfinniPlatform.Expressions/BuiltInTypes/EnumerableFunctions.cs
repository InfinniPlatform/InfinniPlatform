...
{
	static class EnumerableFunctions
	{
		...
		public static bool Equals(IEnumerable first, IEnumerable second, Delegate comparer = null)
		{
			if (first != null && second != null)
			{
				...
				return (comparer != null)
					? firstItems.SequenceEqual(secondItems, new PredicateEqualityComparer(ToFunc<object, object, bool>(comparer)))
		...
		public static IEnumerable Union(IEnumerable first, IEnumerable second, Delegate comparer = null)
		{
			if (first != null && second != null)
			{
				...
				return (comparer != null)
					? firstItems.Union(secondItems, new PredicateEqualityComparer(ToFunc<object, object, bool>(comparer)))
		...
		public static IEnumerable Except(IEnumerable first, IEnumerable second, Delegate comparer = null)
		{
			if (first != null && second != null)
			{
				...
				return (comparer != null)
					? firstItems.Except(secondItems, new PredicateEqualityComparer(ToFunc<object, object, bool>(comparer)))
		...
		public static IEnumerable Intersect(IEnumerable first, IEnumerable second, Delegate comparer = null)
		{
			if (first != null && second != null)
			{
				...
				return (comparer != null)
					? firstItems.Intersect(secondItems, new PredicateEqualityComparer(ToFunc<object, object, bool>(comparer)))
		...
		public static IEnumerable GroupBy(IEnumerable items, Delegate keySelector, Delegate elementSelector = null, Delegate keyComparer = null)
		{
