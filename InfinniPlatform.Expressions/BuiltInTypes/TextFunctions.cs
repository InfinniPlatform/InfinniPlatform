...
namespace InfinniPlatform.Expressions.BuiltInTypes
{
	static class TextFunctions
	{
		...
		{
			return ignoreCase ? string.Equals(left, right, StringComparison.OrdinalIgnoreCase) : string.Equals(left, right);
		}
		...
		public static bool Contains(string value, string substring, bool ignoreCase = false)
		{
			return (value != null && substring != null)
				   && (ignoreCase ? value.IndexOf(substring, StringComparison.OrdinalIgnoreCase) >= 0 : value.Contains(substring));
		}
		...
		{
			return (value != null && substring != null)
				   && (ignoreCase ? value.StartsWith(substring, StringComparison.OrdinalIgnoreCase) : value.StartsWith(substring));
		}

		public static bool EndsWith(string value, string substring, bool ignoreCase = false)
		{
			return (value != null && substring != null)
				   && (ignoreCase ? value.EndsWith(substring, StringComparison.OrdinalIgnoreCase) : value.EndsWith(substring));
		}
		...
		{
			return (value != null && substring != null)
				? value.IndexOf(substring, ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.CurrentCulture)
				: -1;
		}
		...
		public static int IndexOf(string value, string substring, int startIndex = 0, bool ignoreCase = false)
		{
			...
			return (value != null && substring != null)
				? value.IndexOf(substring, Math.Min(startIndex, value.Length - 1), ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.CurrentCulture)
				: -1;
		}
		...
		{
			return (value != null && substring != null)
				? value.LastIndexOf(substring, ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.CurrentCulture)
				: -1;
		}
		...
		public static int LastIndexOf(string value, string substring, int startIndex, bool ignoreCase = false)
		{
			...
			return (value != null && substring != null)
				? value.LastIndexOf(substring, Math.Min(startIndex, value.Length - 1), ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.CurrentCulture)
				: -1;
		}
