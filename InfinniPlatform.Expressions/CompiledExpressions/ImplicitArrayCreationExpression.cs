...
{
	sealed class ImplicitArrayCreationExpression : ICompiledExpression
	{
		...
		public object Execute(object dataContext, ExpressionScope scope)
		{
			...
			var array = (Array)Activator.CreateInstance(elementType.MakeArrayType(arraySizes.Count), arraySizes.ToArray());
