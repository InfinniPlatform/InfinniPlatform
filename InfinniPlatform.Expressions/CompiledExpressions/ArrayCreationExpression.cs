...
{
	sealed class ArrayCreationExpression : ICompiledExpression
	{
		...
		public ArrayCreationExpression(Type elementType, IEnumerable<IEnumerable<ICompiledExpression>> rankSpecifiers, IDictionary<int[], ICompiledExpression> initializers)
		{
