...
namespace InfinniPlatform.Hosting.Implementation.ServiceTemplates
{
    ...
    {
        private readonly IDictionary<string, ServiceTemplate> _serviceTemplateList =
        ...
        {
            return _serviceTemplateList.ContainsKey(containerName.ToLowerInvariant())
                ? _serviceTemplateList[containerName.ToLowerInvariant()]
                : null;
        }
