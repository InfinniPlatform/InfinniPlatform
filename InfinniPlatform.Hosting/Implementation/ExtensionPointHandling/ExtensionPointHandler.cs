...
namespace InfinniPlatform.Hosting.Implementation.ExtensionPointHandling
{
	public sealed class ExtensionPointHandler : IExtensionPointHandler
	{
		...
		private readonly IList<IExtensionPointHandlerInstance> _actionHandlerInstances = new List<IExtensionPointHandlerInstance>();
		...
		public IExtensionPointHandler AddExtensionPoint(string extensionPointName, ContextTypeKind extensionPointContextTypeKind)
		{
		...
		public void AddHandlerInstance(IExtensionPointHandlerInstance extensionPointHandlerInstance)
		{
		    var existingHandler =
		        _actionHandlerInstances.FirstOrDefault(
		            a => a.HandlerInstanceName.ToLowerInvariant() == extensionPointHandlerInstance.HandlerInstanceName.ToLowerInvariant());
	...
	{
		public static IServiceRegistration RegisterHandlerInstance(this IServiceRegistration serviceRegistration, string handlerName, Action<IExtensionPointHandlerInstance> initAction = null)
		{
