...
namespace InfinniPlatform.Hosting.Implementation.ExtensionPointHandling
{
	public sealed class ExtensionPointHandlerInstance : IExtensionPointHandlerInstance
	{
		...
		public IExtensionPointHandlerInstance RegisterExtensionPoint(string extensionPointTypeName, string stateMachineReference)
		{
		...
		{
			return
				_extensionPoints.FirstOrDefault(ex => ex.TypeName.ToLowerInvariant() == extensionPointTypeName.ToLowerInvariant());
		}
