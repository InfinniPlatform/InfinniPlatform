...
namespace InfinniPlatform.Api.Tests.Dynamic
{
	...
	public sealed class DynamicWrapperBehavior
	{
		...
		public void ShouldThrowOnAccessNonExistingObject()
		{
			...
			try
			{
				var tryget = DynamicWrapper.ArrayProperty[0].SomeValue;
			}
			catch
			{
				Assert.Pass();
		...
		public void ShouldFailToAccessNonExistingProperty()
		{
			...
			try
			{
				var tryproperty = DynamicWrapper.SomeObj.SomeValue111;
			}
			catch
			{
				Assert.Pass();
		...
		public void ShouldFailToAccessPropertyForSimpleValue()
		{
			...
			try
			{
				var tryproperty = DynamicWrapper.SomeObj.SomeValue.FailedProperty;
			}
			catch
			{
				Assert.Pass();
		...
		public void ShouldThrowIfIndexIncorrect()
		{
			...
			try
			{
				var tryarrayitem = DynamicWrapper.ArrayProperty[1];
			}
			catch
			{
				Assert.Pass();
		...
		public void ShouldHasProperty()
		{
			...
			var hasProp =  DynamicWrapper.SomeValue != null;
			var notHasProp = DynamicWrapper.NotHasSomeValue != null;
		...
		public void ShouldConvertToJObject()
		{
			...
			//when
			var jobject = JsonConvert.SerializeObject(DynamicWrapper);
		...
		public void ShouldGetProperty()
		{
			...
			//then
			Assert.AreEqual(1,DynamicWrapper.SomeObj.SomeValue);
			var arr = DynamicWrapper.SomeArray;
		...
		public void ShouldInvokeLinqMethodsForSimpleValues()
		{
			...
			var item = enumerable.FirstOrDefault(a => a == "1");
			//then
		...
		public void ShouldInvokeLinqMethodsForObjectsCollections()
		{
			...
			var instance = enumerable.FirstOrDefault(e => e.a == "3");
        ...
        public void ShouldConvertToStringArray()
        {
            ...
            var items = i.StringArray.ToArray();
