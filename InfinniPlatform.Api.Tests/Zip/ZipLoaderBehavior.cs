...
namespace InfinniPlatform.Api.Tests.Zip
{
    ...
    public sealed class ZipLoaderBehavior
    {
        ...
        public void ShouldGetFolderEntries()
        {
            ...
            {
                ZipArchive zipArchive = stream.ReadArchive(Encoding.UTF8);
                IEnumerable<ZipArchiveEntry> entries = zipArchive.GetFolderEntries("Documents");
        ...
        public void ShouldGetFolderEntriesParentedFiles()
        {
            ...
            {
                ZipArchive zipArchive = stream.ReadArchive(Encoding.UTF8);
                IEnumerable<ZipArchiveEntry> entries = zipArchive.GetFileEntries("Documents/Classifiers");
        ...
        public void ShouldGetFolderEntriesParentedFiles1()
        {
            ...
            {
                ZipArchive zipArchive = stream.ReadArchive(Encoding.UTF8);
                IEnumerable<ZipArchiveEntry> entries = zipArchive.GetFileEntries("Documents/Classifiers/Processes");
                Assert.AreEqual(entries.Count(), 2);
            }
        }
        ...
        public void ShouldGetFolderEntriesParentedFolders()
        {
            ...
            {
                ZipArchive zipArchive = stream.ReadArchive(Encoding.UTF8);
                IEnumerable<ZipArchiveEntry> entries = zipArchive.GetFolderEntries("Documents/Classifiers");
