...
namespace InfinniPlatform.Api.Tests.Extensions
{
	...
	public class CommonExtensionsTest
	{
		...
		{
			// When
			var actual = target.Replace(oldValue, newValue, true, true);
		...
		{
			// When
			var actual = target.FindNextIndexOf(value, 0, true, true);
		...
		{
			// When
			var actual = target.Replace(oldValue, newValue, true, false);
		...
		{
			// When
			var actual = target.FindNextIndexOf(value, 0, true, false);
		...
		{
			// When
			var actual = target.Replace(oldValue, newValue, false, true);
		...
		{
			// When
			var actual = target.FindNextIndexOf(value, 0, false, true);
		...
		[TestCase("Some \"AOldValue\" string", "OldValue", "NewValue", "Some \"ANewValue\" string")]
		[TestCase("Some .*? string", ".*?", "NewValue", "Some NewValue string")]
		public void ReplaceWhenNotMatchCaseAndNotWholeWord(string target, string oldValue, string newValue, string expected)
		{
			// When
			var actual = target.Replace(oldValue, newValue, false, false);
		...
		{
			// When
			var actual = target.FindNextIndexOf(value, 0, false, false);
