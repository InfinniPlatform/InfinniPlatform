...
namespace InfinniPlatform.Api.Tests.RestBehavior.DataSources
{
	...
	public sealed class MetadataDataSourceBehavior
	{
		...
		public void ShouldGetMetadata()
		{
			...
			IEnumerable<dynamic> resultConfig = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getregisteredconfiglist", null, null).ToDynamic().ConfigList;
			...
			bodyQuery = DynamicWrapperExtensions.ToDynamic(QueryMetadata.GetConfigurationMetadataShortListIql(metadataSourceDocument.ConfigId, new MetadataContainerDocument().GetMetadataContainerName()));
			...
			bodyQuery = DynamicWrapperExtensions.ToDynamic((string)QueryMetadata.GetConfigurationMetadataByNameIql(metadataSourceDocument.ConfigId, metadataSourceDocument.DocumentId, new MetadataContainerDocument().GetMetadataContainerName(), new MetadataContainerDocument().GetMetadataTypeName()));
			...
			bodyQuery = DynamicWrapperExtensions.ToDynamic((string)QueryMetadata.GetDocumentMetadataShortListIql(metadataSourceDocumentElement.ConfigId, metadataSourceDocumentElement.DocumentId, new MetadataContainerView().GetMetadataContainerName()));
			...
			bodyQuery = DynamicWrapperExtensions.ToDynamic((string)QueryMetadata.GetConfigurationMetadataShortListIql(metadataSourceDocumentMenuList.ConfigId, metadataSourceDocumentMenuList.MetadataType));
			...
			bodyQuery = DynamicWrapperExtensions.ToDynamic((string)QueryMetadata.GetConfigurationMetadataByNameIql(metadataSourceDocumentMenu.ConfigId, metadataSourceDocumentMenu.MetadataName, "Menu", metadataSourceDocumentMenu.MetadataType));
			response = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getmetadata", null, bodyQuery);
		...
		public void ShouldGetMetadataByApi()
		{
			...
			dynamic result = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getconfigurationmetadata", null, metadataSource).ToDynamic();
			...
			IEnumerable<dynamic> docs = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getdocumentlistmetadata", null, metadataSourceDocumentList).ToDynamicList();
			...
			result = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getdocumentmetadata", null, metadataSourceDocument).ToDynamic();
			...
			IEnumerable<dynamic> elements = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getdocumentelementlistmetadata", null, metadataSourceDocumentElement).ToDynamicList();
			...
			IEnumerable<dynamic> resultList = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getmenulistmetadata", null, metadataSourceDocumentMenuList).ToDynamicList();
			...
			result = RestQueryApi.QueryPostJsonRaw("systemconfig", "metadata", "getmenumetadata", null, metadataSourceDocumentMenu).ToDynamic();
		...
		private static void CreateTestConfiguration()
		{
            ...
            dynamic validationError = DynamicWrapperExtensions.ToDynamic(ValidationOperatorSerializer.Instance.Serialize(ValidationBuilder.ForObject(builder => builder.And(rules => rules
            ...
            dynamic validationWarning = DynamicWrapperExtensions.ToDynamic(ValidationOperatorSerializer.Instance.Serialize(ValidationBuilder.ForObject(builder => builder.Or(rules => rules
																			.IsEqual("LastName", "test", "Last name not satisfy")
																			.IsNotNullOrWhiteSpace("LastName",
																								   "LastName is empty")))));
