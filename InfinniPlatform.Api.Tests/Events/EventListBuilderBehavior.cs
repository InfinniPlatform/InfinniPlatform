...
namespace InfinniPlatform.Api.Tests.Events
{
    ...
    public sealed class EventListBuilderBehavior
    {
        ...
        public void ShouldCreateEventsForLastCollectionItem()
        {
            ...
            string[] events = obj.ToEventListCollectionItem("Menu").GetSerializedEvents().ToArray();
        ...
        public void ShouldCreateEventsFromDynamicWrapper()
        {
            ...
            IEnumerable<string> eventStrings = new EventList(obj.ToDynamic(), "").GetSerializedEvents();

            File.WriteAllLines("1.txt", eventStrings);

            string expectedResult = "{\"Property\":\"TestProperty\",\"Value\":\"123\",\"Action\":2,\"Index\":-1}" +
        ...
        public void ShouldCreateEventsFromJObject()
        {
            ...
            IEnumerable<string> eventStrings = jobject.ToEventListAsObject("").GetSerializedEvents();
            File.WriteAllLines("1.txt", eventStrings);
