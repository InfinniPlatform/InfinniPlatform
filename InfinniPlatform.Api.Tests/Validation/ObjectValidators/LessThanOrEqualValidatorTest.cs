...
namespace InfinniPlatform.Api.Tests.Validation.ObjectValidators
{
	...
	public sealed class LessThanOrEqualValidatorTest
	{
		...
		{
			// Given
			var validator = new LessThanOrEqualValidator { Value = testCase.Value, Message = "Error" };

			// When
			var result = new ValidationResult();
			var isValid = validator.Validate(testCase.ValidationObject, result);
