...
namespace InfinniPlatform.Api.Tests.Validation
{
	...
	public sealed class BaseValidationOperatorTest
	{
		...
		public void ShouldBuildValidationResultWhenFail(string parentProperty, string validationProperty, string expectedPropertyPath)
		{
			// Given
			...
			var isValid = validator.Validate(null, result, parentProperty);
		...
		public void ShouldBuildValidationResultWhenSuccess()
		{
			...
			// When
			var result = new ValidationResult();
			var isValid = validator.Validate(null, result);
