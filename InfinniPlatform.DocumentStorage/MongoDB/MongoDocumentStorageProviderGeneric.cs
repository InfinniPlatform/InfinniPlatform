...
namespace InfinniPlatform.DocumentStorage.MongoDB
{
    ...
    internal sealed class MongoDocumentStorageProvider<TDocument> : IDocumentStorageProvider<TDocument>
    {
        ...
        public DocumentBulkResult Bulk(Action<IDocumentBulkBuilder<TDocument>> bulk, bool isOrdered = false)
        {
            var requests = MongoDocumentBulkBuilderGeneric<TDocument>.CreateMongoBulk(_filterBuilder, bulk);
        ...
        public async Task<DocumentBulkResult> BulkAsync(Action<IDocumentBulkBuilder<TDocument>> bulk, bool isOrdered = false)
        {
            var requests = MongoDocumentBulkBuilderGeneric<TDocument>.CreateMongoBulk(_filterBuilder, bulk);
