...
{
    /// <summary>
    /// Команда обновления набора документов в хранилище.
    /// </summary>
    public sealed class DocumentUpdateManyCommand : IDocumentWriteCommand
    {
        /// <summary>
        /// Конструктор.
        /// </summary>
        ...
        public DocumentUpdateManyCommand(Action<IDocumentUpdateBuilder> update, Func<IDocumentFilterBuilder, object> filter = null, bool insertIfNotExists = false)
        {
            Update = update;
            Filter = filter;
    ...
    /// Команда обновления набора документов в хранилище.
    /// </summary>
    public sealed class DocumentUpdateManyCommand<TDocument> : IDocumentWriteCommand<TDocument>
    {
        /// <summary>
        /// Конструктор.
        /// </summary>
        ...
        /// <param name="filter">Фильтр для поиска документов.</param>
        /// <param name="insertIfNotExists">Следует ли создать документ, если ничего не найдено.</param>
        public DocumentUpdateManyCommand(Action<IDocumentUpdateBuilder<TDocument>> update, Expression<Func<TDocument, bool>> filter = null, bool insertIfNotExists = false)
        {
            Update = update;
            Filter = filter;
            InsertIfNotExists = insertIfNotExists;
