...
{
    internal sealed class MongoSetDocumentExecutor : ISetDocumentExecutor
    {
        public MongoSetDocumentExecutor(IDocumentTransactionScopeProvider transactionScopeProvider, IMetadataApi metadataComponent, IScriptProcessor scriptProcessor)
        {
        ...
        private DocumentExecutorResult ExecuteSaveDocuments(string documentType, IEnumerable<object> documentInstances)
        {
            ...
            foreach (dynamic documentInstance in documentInstances)
            {
                ...
                documentInstance._id = documentInstance.Id;
