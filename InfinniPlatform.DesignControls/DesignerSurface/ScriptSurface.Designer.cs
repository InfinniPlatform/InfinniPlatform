namespace InfinniPlatform.DesignControls.DesignerSurface
{
    partial class ScriptSurface
    {
        ...
        private void InitializeComponent()
        {
			...
			this.GridControlScripts = new DevExpress.XtraGrid.GridControl();
			this.gridBinding = new System.Windows.Forms.BindingSource(this.components);
			this.GridViewScripts = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.ScriptSourceColumn = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			((System.ComponentModel.ISupportInitialize)(this.GridControlScripts)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridBinding)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.GridViewScripts)).BeginInit();
			...
			// GridControlScripts
			// 
			this.GridControlScripts.DataSource = this.gridBinding;
			this.GridControlScripts.Dock = System.Windows.Forms.DockStyle.Fill;
			this.GridControlScripts.Location = new System.Drawing.Point(0, 0);
			this.GridControlScripts.MainView = this.GridViewScripts;
			this.GridControlScripts.Name = "GridControlScripts";
			this.GridControlScripts.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemButtonEditSource});
			this.GridControlScripts.Size = new System.Drawing.Size(700, 325);
			this.GridControlScripts.TabIndex = 3;
			this.GridControlScripts.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.GridViewScripts});
			// 
			// GridViewScripts
			// 
			this.GridViewScripts.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.ScriptSourceColumn});
			this.GridViewScripts.GridControl = this.GridControlScripts;
			this.GridViewScripts.Name = "GridViewScripts";
			this.GridViewScripts.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.False;
			this.GridViewScripts.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.False;
			this.GridViewScripts.OptionsCustomization.AllowColumnMoving = false;
			this.GridViewScripts.OptionsCustomization.AllowColumnResizing = false;
			this.GridViewScripts.OptionsCustomization.AllowFilter = false;
			this.GridViewScripts.OptionsCustomization.AllowGroup = false;
			this.GridViewScripts.OptionsCustomization.AllowQuickHideColumns = false;
			this.GridViewScripts.OptionsCustomization.AllowSort = false;
			this.GridViewScripts.OptionsView.ShowGroupPanel = false;
			this.GridViewScripts.CustomColumnDisplayText += new DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventHandler(this.GridViewScripts_CustomColumnDisplayText);
			// 
			// ScriptSourceColumn
			// 
			this.ScriptSourceColumn.Caption = "ScriptSource";
			this.ScriptSourceColumn.ColumnEdit = this.repositoryItemButtonEditSource;
			this.ScriptSourceColumn.FieldName = "ScriptSourceName";
			this.ScriptSourceColumn.Name = "ScriptSourceColumn";
			this.ScriptSourceColumn.OptionsColumn.AllowGroup = DevExpress.Utils.DefaultBoolean.False;
			this.ScriptSourceColumn.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.ScriptSourceColumn.Visible = true;
			this.ScriptSourceColumn.VisibleIndex = 0;
			// 
			...
			this.PanelButtons.Size = new System.Drawing.Size(700, 34);
			...
			this.DeleteScriptButton.Text = "Delete Script";
			...
			this.Controls.Add(this.GridControlScripts);
			this.Controls.Add(this.PanelButtons);
			this.Name = "ScriptSurface";
			this.Size = new System.Drawing.Size(700, 359);
			((System.ComponentModel.ISupportInitialize)(this.GridControlScripts)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridBinding)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.GridViewScripts)).EndInit();
        ...
        private DevExpress.XtraGrid.GridControl GridControlScripts;
        private DevExpress.XtraGrid.Views.Grid.GridView GridViewScripts;
        private DevExpress.XtraGrid.Columns.GridColumn ScriptSourceColumn;
