...
{
    public partial class PopupButton : UserControl, IPropertiesProvider, ILayoutProvider, IClientHeightProvider,
        IInspectedItem
    {
        private readonly Dictionary<string, CollectionProperty> _collectionProperties =
            new Dictionary<string, CollectionProperty>();

        private readonly CollectionProperty _collectionProperty =
            new CollectionProperty(new Dictionary<string, IControlProperty>().GetActionElements());
