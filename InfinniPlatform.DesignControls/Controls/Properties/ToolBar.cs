...
namespace InfinniPlatform.DesignControls.Controls.Properties
{
    ...
    {
        public static Dictionary<string, CollectionProperty> InheritToolBarButtonCollectionProperties(this Dictionary<string, CollectionProperty> properties, int recursiveIndex = 0)
        {
            if (recursiveIndex > 3)
            {
