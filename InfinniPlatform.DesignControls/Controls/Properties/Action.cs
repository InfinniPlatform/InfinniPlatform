			...
			return new Dictionary<string, IControlProperty>()
				       {
					       {"AddAction",new ObjectProperty(new Dictionary<string, IControlProperty>()
						                                       {							                                       
																   ...
																   {"View",new ObjectProperty(new Dictionary<string, IControlProperty>().GetLinkViews(),new Dictionary<string, CollectionProperty>())},
						                                       }, 
					       ...
					       {"AddItemAction",new ObjectProperty(new Dictionary<string, IControlProperty>()
						                                       {							                                       
																   {"Items", new ObjectProperty(new Dictionary<string, IControlProperty>().GetBindings(), new Dictionary<string, CollectionProperty>())},
																   {"View",new ObjectProperty(new Dictionary<string, IControlProperty>().GetLinkViews(),new Dictionary<string, CollectionProperty>())},
						                                       }, 
															   new Dictionary<string, CollectionProperty>(), 
															   new Dictionary<string, Func<Func<string, dynamic>, ValidationResult>>()
                          ...
                          {"CancelAction",new ObjectProperty(new Dictionary<string, IControlProperty>()
					       ...
					       {"SelectAction",new ObjectProperty(new Dictionary<string, IControlProperty>()
						                                       {							                                       
																   {"SourceValue",new ObjectProperty(new Dictionary<string, IControlProperty>().GetBindings(), new Dictionary<string, CollectionProperty>())},
                                                                   {"DestinationValue",new ObjectProperty(new Dictionary<string, IControlProperty>().GetBindings(), new Dictionary<string, CollectionProperty>())},
																   {"View",new ObjectProperty(new Dictionary<string, IControlProperty>().GetLinkViews(),new Dictionary<string, CollectionProperty>())},
						                                       }, 
															   new Dictionary<string, CollectionProperty>(), 
															   new Dictionary<string, Func<Func<string, dynamic>, ValidationResult>>()
