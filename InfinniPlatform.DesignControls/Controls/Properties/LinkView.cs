...
namespace InfinniPlatform.DesignControls.Controls.Properties
{
	...
	{
        public static Dictionary<string, IControlProperty> GetLinkViews(this Dictionary<string, IControlProperty> properties)
		{
            properties.Add("ExistsView", new ObjectProperty(new Dictionary<string, IControlProperty>()
				...
				.InheritBaseLinkViewSimpleProperties(), new Dictionary<string, CollectionProperty>().InheritBaseLinkViewCollectionProperties(),
