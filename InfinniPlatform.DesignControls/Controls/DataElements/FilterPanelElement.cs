...
{
	public partial class FilterPanelElement : UserControl, IPropertiesProvider, ILayoutProvider, IInspectedItem, IClientHeightProvider
	{
		...
		private void ApplyProperties(CollectionProperty property, GridPanel panelToAdd)
		{
			...
			{
				int rowIndex = i / ItemsInRow();
				int colIndex = i % ItemsInRow();
        ...
        private readonly CollectionProperty _generalProperties = new CollectionProperty(new Dictionary<string, IControlProperty>()
		                                                                 {
        ...
        private readonly CollectionProperty _additionalProperties = new CollectionProperty(new Dictionary<string, IControlProperty>()
		                                                                 {
			                                                                 {"Text", new SimpleProperty(string.Empty)},
																			 {"Property", new SimpleProperty(string.Empty)},
			                                                                 {"DefaultOperator", new SimpleProperty(1)},
