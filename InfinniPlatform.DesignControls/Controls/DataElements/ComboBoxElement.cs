...
{
    public partial class ComboBoxElement : UserControl, IPropertiesProvider, ILayoutProvider, IClientHeightProvider,IInspectedItem
    {
        ...
        private void InitProperties()
        {
            ...
            _simpleProperties.Add("SelectView", new ObjectProperty(new Dictionary<string, IControlProperty>().GetLinkViews(), new Dictionary<string, CollectionProperty>()));
        ...
        {
            base.OnResize(e);
            ComboBoxEdit.Width = this.Width - this.Margin.Left - this.Margin.Right;
        }
	    ...
	    {
		    return new Dictionary<string, Func<Func<string, dynamic>, ValidationResult>>().InheritBaseElementValidators("ComboBox");
	    }
