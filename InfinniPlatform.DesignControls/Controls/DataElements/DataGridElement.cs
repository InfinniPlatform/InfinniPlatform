...
{
	public partial class DataGridElement : UserControl, IPropertiesProvider, ILayoutProvider, IInspectedItem, IClientHeightProvider 
	{
		...
		public void ApplySimpleProperties()
		{
            ...
            ScriptEditor.Script = ((ObjectProperty)_properties["Items"]).Value.PropertyBinding != null ? ((ObjectProperty)_properties["Items"]).Value.PropertyBinding.ToString() : "";
		}
		...
		public Dictionary<string, Func<Func<string, dynamic>, ValidationResult>> GetValidationRules()
		{
			return new Dictionary<string, Func<Func<string, dynamic>, ValidationResult>>()
				       ...
				       }.InheritBaseElementValidators("DataGrid");
		}
