...
namespace InfinniPlatform.DesignControls.ObjectInspector
{
    public partial class ObjectInspectorTree : UserControl
    {
        ...
        private void SettingsButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (ControlsTree.FocusedNode == null)
            {
                MessageBox.Show(Resources.NoItemSelected, Resources.NeedToSelectItem, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void ButtonCut_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (ControlsTree.FocusedNode == null)
            {
                MessageBox.Show(Resources.NoItemSelected, Resources.NeedToSelectItem, MessageBoxButtons.OK, MessageBoxIcon.Information);
	    ...
	    private void MoveToClipboard(PropertiesNode focusedPropertiesNode, bool delete)
	    {
		    ...
		    {
			    MessageBox.Show(string.Format("Can't make clipboard operation on element \"{0}\"", focusedPropertiesNode.ControlName),
	    ...
	    private void ButtonPaste_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (ControlsTree.FocusedNode == null)
            {
            ...
            {
                MessageBox.Show(Resources.ClipboardIsEmpty, Resources.Warnings, MessageBoxButtons.OK, MessageBoxIcon.Exclamation,
	    ...
	    private readonly Dictionary<PropertiesNode, TreeListNode> _nodes = new Dictionary<PropertiesNode, TreeListNode>();  
        ...
        private void ButtonDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format(Resources.ConfirmDeleteDocument, focusedPropertiesNode.ControlName),
                    Resources.NeedConfirm, MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) ==
                DialogResult.Cancel)
            {
                return;
            }
        ...
        private List<ResizerFixed> _resizers = new List<ResizerFixed>();
