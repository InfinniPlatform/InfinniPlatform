...
namespace InfinniPlatform.DesignControls.ObjectInspector
{
    ...
    {
        private static readonly List<Tuple<string, Type, string, IEnumerable<EnabledItems>>> _controlTypes = new List
            <Tuple<string, Type, string, IEnumerable<EnabledItems>>>
        {
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("PopupButton", typeof (PopupButton), "Action",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("Button", typeof (Button), "Action",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ToggleButton", typeof (ToggleButtonElement),
                "Action", new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("MenuBar", typeof (MenuBar), "Action",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ToolBar", typeof (ToolBar), "Action",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("TabPanel", typeof (TabPanel), "Layout",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("GridPanel", typeof (GridPanel), "Layout",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ViewPanel", typeof (ViewPanel), "Layout",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("Panel", typeof (Panel), "Layout",
                new List<EnabledItems> {EnabledItems.Action, EnabledItems.Data, EnabledItems.Layout}),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ScrollPanel", typeof (ScrollPanel), "Layout",
                new List<EnabledItems> {EnabledItems.Action, EnabledItems.Data, EnabledItems.Layout}),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("StackPanel", typeof (StackPanel), "Layout",
                new List<EnabledItems> {EnabledItems.Action, EnabledItems.Data, EnabledItems.Layout}),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("SearchPanel", typeof (SearchPanelElement),
                "Data", new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("FilterPanel", typeof (FilterPanelElement),
                "Data", new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ComboBox", typeof (ComboBoxElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("TextBox", typeof (TextEditElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("CheckBox", typeof (CheckBoxElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("DatePicker", typeof (DatePickerElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("ListBox", typeof (ListBoxElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("Label", typeof (LabelElement), "Data",
                new List<EnabledItems>()),
            new Tuple<string, Type, string, IEnumerable<EnabledItems>>("DataGrid", typeof (DataGridElement), "Data",
                new List<EnabledItems>())
        };

        private static readonly Dictionary<ObjectInspectorTree, ControlRepository> ControlRepositories =
            new Dictionary<ObjectInspectorTree, ControlRepository>();
        ...
        public PropertiesNode CreateControl(Tuple<string, Type, string, IEnumerable<EnabledItems>> controlConstructor)
        {
            ...
            propertiesNode.ControlName = controlConstructor.Item1 + _index++;
        ...
        public PropertiesNode CreateNotImplementedControl(string key)
        {
            ...
            var propertiesNode = new PropertiesNode(control);
            propertiesNode.ControlName = key + _index++;
