...
{
    public sealed class DenyAccessHandlerRegistration : HandlerRegistration
    {
        public DenyAccessHandlerRegistration() : base(new RouteFormatterStandard(), new RequestPathConstructor(), Priority.Higher, "POST")
        {
        }
        ...
        {
            return
                RouteFormatter.FormatRoutePath(context, new PathString(PathConstructor.GetUserPath() + "/DenyAccess"))
