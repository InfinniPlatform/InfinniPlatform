...
namespace InfinniPlatform.Api.RestApi.CommonApi
{
    ...
    public static class RestQueryApi
    {
                ...
                _queryBuilder = (version, configuration, metadata, action) =>
                    new LocalQueryBuilder(configuration, metadata, action,
                        !string.IsNullOrEmpty(Thread.CurrentPrincipal.Identity.Name)
                            ...
                            : AuthorizationStorageExtensions.UnknownUser, version, _operationProfiler);
            }
            else
            {
                _queryBuilder = (version, configuration, metadata, action) =>
        ...
        public static RestQueryResponse QueryPostFile(string configuration, string metadata, string action,
            object linkedData, string filePath, string version = null)
        {
        ...
        public static RestQueryResponse QueryPostFile(string configuration, string metadata, string action,
            object linkedData, Stream fileStream, string version = null)
        {
            var builder = _queryBuilder(version, configuration, metadata, action);
        ...
        public static RestQueryResponse QueryPostUrlEncodedData(string configuration, string metadata, string action,
            object linkedData, string version = null)
        {
            var builder = _queryBuilder(version, configuration, metadata, action);
        ...
        public static RestQueryResponse QueryGetUrlEncodedData(string configuration, string metadata, string action,
            object linkedData, string version = null)
        {
            var builder = _queryBuilder(version, configuration, metadata, action);
        ...
        public static RestQueryResponse QueryPostRaw(string configuration, string metadata, string action, string id,
            object body, string version = null, bool replace = false)
        {
            var builder = _queryBuilder(version, configuration, metadata, action);
        ...
        public static RestQueryResponse QueryGetRaw(string configuration, string metadata, string action,
            IEnumerable<object> filter, int pageNumber, int pageSize, string version = null)
        {
            var profiler = _operationProfiler(configuration, metadata, action, null);
        ...
        public static RestQueryResponse QueryAggregationRaw(string configuration, string metadata, string action,
            string aggregationConfiguration, string aggregationMetadata, IEnumerable<object> filterObject,
            IEnumerable<dynamic> dimensions, IEnumerable<AggregationType> aggregationTypes,
            IEnumerable<string> aggregationFields, int pageNumber, int pageSize, IRouteTrace routeTrace = null,
            string version = null)
        {
