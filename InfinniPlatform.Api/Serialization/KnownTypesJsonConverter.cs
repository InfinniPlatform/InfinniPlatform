...
namespace InfinniPlatform.Api.Serialization
{
	...
	/// </summary>
	sealed class KnownTypesJsonConverter : JsonConverter
	{
		...
		{
			return _knownTypes.HasType(objectType) || ((objectType.IsInterface || objectType.IsAbstract) && !_enumerableType.IsAssignableFrom(objectType));
		}
