namespace InfinniPlatform.Api.Index
{
    ...
    ///     версии индекса)
    ///     2. Версионирование на уровне индекса (существование нескольких версий индекса одних и тех же матаданных, записи
    ///     внутри каждого индекса,
    ...
    public interface IVersionBuilder
    {
        ...
        ///     Считается, что версия существует, если все свойства переданного маппинга соответсвуют по типу всем имеющимся
        ///     свойствам,
