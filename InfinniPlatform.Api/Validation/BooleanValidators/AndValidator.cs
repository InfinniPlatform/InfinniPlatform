...
namespace InfinniPlatform.Api.Validation.BooleanValidators
{
	...
	{
		public override bool Validate(object validationObject, ValidationResult validationResult = null, string parentProperty = null)
		{
			var isValid = true;
			...
			if (Operators != null && Operators.Any())
			{
				...
				{
					isValid &= validationOperator.Validate(propertyValue, itemValidationResult, ValidationExtensions.CombineProperties(parentProperty, Property));
				}
			}
