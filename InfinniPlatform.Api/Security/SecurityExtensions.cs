...
namespace InfinniPlatform.Api.Security
{
    ...
    public static class SecurityExtensions
    {
        ...
        {
            return identity.AsClaimsIdentity<IEnumerable<T>>(claimType, (ci, ct) =>
            {
                var claims = ci.FindAll(ct);
        ...
        private static TResult AsClaimsIdentity<TResult>(this IIdentity identity, string claimType,
            Func<ClaimsIdentity, string, TResult> action)
        {
        ...
        private static void AsClaimsIdentity(this IIdentity identity, string claimType, string claimValue,
            Action<ClaimsIdentity, string, string> action)
        {
            var claimsIdentity = identity as ClaimsIdentity;
