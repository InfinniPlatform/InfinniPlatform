...
namespace InfinniPlatform.Api.Security
{
    ...
    public sealed class ApplicationClaimType
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Идентификатор утверждения должен совпадать со значениями из <see cref="ClaimTypes" /> или
        ///     <see cref="ApplicationClaimTypes" />.
        /// </remarks>
        /// <example>
        ...
        /// </summary>
        /// <remarks>
        ///     Идентификатор утверждения должно совпадать с наименованиями из <see cref="ClaimTypes" /> или
        ///     <see cref="ApplicationClaimTypes" />.
        /// </remarks>
        /// <example>
        ///     MobilePhone
