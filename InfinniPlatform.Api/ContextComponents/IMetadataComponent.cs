...
namespace InfinniPlatform.Api.ContextComponents
{
    ...
    public interface IMetadataComponent
    {
        ...
        dynamic GetMetadata(string version, string configId, string objectMetadataId, string metadataType,
            string metadataName);
        ...
        dynamic GetMetadataItem(string version, string configId, string objectMetadataId, string metadataType,
        ...
        IEnumerable<dynamic> GetMetadataList(string version, string configId, string objectMetadataId,
            string metadataType);
    }
}