...
namespace InfinniPlatform.Api.ContextComponents
{
    ...
    public interface IRegistryComponent
    {
        ...
        dynamic CreateAccumulationRegisterEntry(string configId, string registerId, string documentId,
        ...
        /// <param name="documentDate">Дата документа</param>
        /// <returns>Заготовка записи в регистр, которая может быть дополнена при необходимости</returns>
        dynamic CreateInfoRegisterEntry(string configId, string registerId, string documentId, dynamic sourceDocument,
