...
namespace InfinniPlatform.Api.Schema.Prefill
{
	public sealed class TestDataBuilder
	{
        ...
        readonly Dictionary<string, Func<dynamic, dynamic>> _fillSettings = new Dictionary<string, Func<dynamic,dynamic>>();
	    ...
	    public dynamic Build(dynamic instance = null)
	    {
            ...
            foreach (KeyValuePair<string, Func<dynamic,dynamic>> fillSetting in _fillSettings)
            {
        ...
        public TestDataBuilder FillExpressionProperty(string propertyName, Func<dynamic, dynamic> fillPropertyAction, int count = 1)
        {
            _fillSettings.Add(propertyName, buildInstance => _defaultValues.GetRandomValue(fillPropertyAction(buildInstance), count));
            return this;
        }
