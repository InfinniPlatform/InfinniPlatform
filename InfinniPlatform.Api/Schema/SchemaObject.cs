...
{
	public enum PathResolveType { Select, Where }
	...
	public sealed class SchemaObject
	{
		...
		public bool Inline
		{
			get
			{
				return Value.TypeInfo != null && Value.TypeInfo.DocumentLink != null && Value.TypeInfo.DocumentLink.Inline != null &&
		...
		{
			get { return Value != null && Value.Items != null && Value.Items.TypeInfo != null && Value.Items.TypeInfo.DocumentLink != null; }
		}

		public string ConfigId
		{
			get { return Value != null && Value.TypeInfo != null && Value.TypeInfo.DocumentLink != null ? Value.TypeInfo.DocumentLink.ConfigId : null; }
		}

		public string DocumentId
		{
			get { return Value != null && Value.TypeInfo != null && Value.TypeInfo.DocumentLink != null ? Value.TypeInfo.DocumentLink.DocumentId : null; }
		}
