...
namespace InfinniPlatform.Api.TestEnvironment
{
    public class TestServerParametersBuilder
    {
        ...
        /// <summary>
        ///     Установить конфигурацию из JSON конфигурации (в хранилище ElasticSearch) с указанием используемых прикладных
        ///     сборок.
        /// </summary>
        ...
        /// <summary>
        ///     Установить конфигурацию из JSON конфигурации (из ZIP файла с архивом конфигурации, без создания конфигурации в
        ///     ElasticSearch) с указанием используемых прикладных сборок.
        /// </summary>
