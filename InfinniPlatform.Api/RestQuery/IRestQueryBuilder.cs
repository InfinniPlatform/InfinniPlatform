...
namespace InfinniPlatform.Api.RestQuery
{
	...
	public interface IRestQueryBuilder
	{
		...
		/// <param name="cookieContainer"></param>
		/// <returns>Ответ на вызов сервиса</returns>
		RestQueryResponse QueryGet(IEnumerable<object> filterObject, int pageNumber, int pageSize, int searchType = 1, string version = null, CookieContainer cookieContainer = null);
