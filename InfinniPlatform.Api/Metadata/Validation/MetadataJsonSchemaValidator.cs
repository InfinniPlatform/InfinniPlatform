...
namespace InfinniPlatform.Api.Metadata.Validation
{
	...
	/// </summary>
	sealed class MetadataJsonSchemaValidator : IMetadataSchemaValidator
	{
		...
		private static MetadataSchemaError CreateSchemaError(ValidationEventArgs errorInfo)
		{
			return (errorInfo.Exception != null)
				? new MetadataSchemaError(errorInfo.Exception.Message, errorInfo.Exception.Path, errorInfo.Exception.LineNumber, errorInfo.Exception.LinePosition)
