...
{
	sealed class MetadataReaderDocumentElement : MetadataReader
	{
        ...
        private void ConvertStringToJsonProperties(dynamic resultItem)
        {
			...
			if ((_metadataContainerInfo.GetMetadataTypeName() == MetadataType.ValidationError || _metadataContainerInfo.GetMetadataTypeName() == MetadataType.ValidationWarning) && resultItem != null)
			{
