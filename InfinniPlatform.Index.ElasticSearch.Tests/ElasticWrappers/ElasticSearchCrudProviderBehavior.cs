...
namespace InfinniPlatform.Index.ElasticSearch.Tests.ElasticWrappers
{
    ...
    public sealed class ElasticSearchCrudProviderBehavior
    {
        ...
        public void ShouldCrudOperations()
        {
            ...
            var elasticProvider1 = new ElasticSearchProvider("elasticcrudbehavior","testtype",AuthorizationStorageExtensions.AnonimousUser);
			var elasticProvider2 = new ElasticSearchProvider("elasticcrudbehavior", "testtype1", AuthorizationStorageExtensions.AnonimousUser);
			var elasticProvider3 = new ElasticSearchProvider("elasticcrudbehavior1", "testtype", AuthorizationStorageExtensions.AnonimousUser);
			var elasticProvider4 = new ElasticSearchProvider("elasticcrudbehavior1", "testtype_another", AuthorizationStorageExtensions.AnonimousUser);

            dynamic instance1 = new DynamicWrapper();
            var instance1Id = "1elasticcrudbehavior_testtype_first";
            var simpleField1 = "first element (string!)";
            ...
            var count =  elasticProvider1.GetTotalCount();
            Assert.AreEqual(1,count);

            //добавим вторую сущность в индекс
            dynamic instance2 = new DynamicWrapper();
            var instance2Id = "2elasticcrudbehavior_testtype_second";
            var simpleField2 = "second element (string!)";
            ...
            var simpleFieldUpdate = "field updated";
            ...
            var instance3Id = "3elasticcrudbehavior_testtype_third";
            var simpleField3 = "third element (string!)";
            ...
            elasticProvider1.SetItems(new dynamic[] {instance1,instance2,instance3});
            elasticProvider1.Refresh();

            count = elasticProvider1.GetTotalCount();
            Assert.AreEqual(3,count);

            var itemsArr = elasticProvider1.GetItems(new [] { instance1Id, instance2Id, instance3Id }).ToArray();
            ...
            var instance4Id = "4elasticcrudbehavior_testtype1_fourth";
            var simpleField4 = "fourth element (string!)";
            ...
            Assert.Throws<ArgumentException>(() => elasticProvider1.Set(failInstance),Resources.InappropriateItemMapping);
            ...
            var notExistingItems = elasticProvider2.GetItems(new string[] {instance1Id});
            Assert.AreEqual(0,notExistingItems.Count());
            notExistingItems = elasticProvider3.GetItems(new string[] { instance1Id });
            Assert.AreEqual(0, notExistingItems.Count());
            notExistingItems = elasticProvider4.GetItems(new string[] { instance1Id });
            Assert.AreEqual(0, notExistingItems.Count());
