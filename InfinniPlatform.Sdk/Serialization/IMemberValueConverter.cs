...
namespace InfinniPlatform.Sdk.Serialization
{
    ...
    /// операций сериализации и десериализации. На прикладном уровне необходимо реализовать интерфейс <see cref="IMemberValueConverter" />
    /// и зарегистрировать реализацию в реестре <see cref="MemberValueConverterRegistry" /> перед началом работы приложения.
    /// </remarks>
