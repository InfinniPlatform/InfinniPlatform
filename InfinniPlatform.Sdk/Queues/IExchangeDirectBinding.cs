...
namespace InfinniPlatform.Sdk.Queues
{
    ...
    /// </summary>
    /// <remarks>
    ///     Маршрутизация сообщений для точек обмена с типом "Direct" осуществляется от издателя во все очереди, связанные с
    ///     точкой обмена и
    ...
    public interface IExchangeDirectBinding
    {
        ...
        /// <remarks>
        ///     При формировании ключа маршрутизации используются следующие соглашения. Ключ должен быть пустым, либо состоять из
        ///     слов,
        ///     разделенных точками. Каждое слово может содержать симоволы из набора [a-zA-Z0-9].
        /// </remarks>
        void Subscribe(string queue, Func<IQueueConsumer> consumer, string routingKey,
