...
namespace InfinniPlatform.Core.Tests.Builders
{
    public static class ConfigurationBuilder
    {
        ...
        private static dynamic BuildMainMenu()
        {
            ...
            var metadata = metadataObject
                ...
                .BuildProperty("Caption", "Справочники НСИ")
                .BuildProperty("Description", "Главное меню конфигурации справочников НСИ")
                .BuildMenuItem("Основное",
                               mi =>
                               mi.BuildMenuItem("Просмотр справочников НСИ",
                                                min => min.BuildOpenViewAction(ov => ov.BuildSelectListView(
                                                    slv => slv
                                                               ...
                                                               .BuildDataSourcesList(
                                                                   ...
                                                                   dsl.BuildDataSource(
                                                                       ds =>
                                                                       ds.BuildMetadataDataSource("SelectDataSource",
                                                                                                  "ClassifierStorage",
                                                                                                  "Classifier")))
