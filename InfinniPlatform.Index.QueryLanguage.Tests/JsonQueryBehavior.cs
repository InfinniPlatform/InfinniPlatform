...
namespace InfinniPlatform.Index.QueryLanguage.Tests
{
    ...
    public sealed class JsonQueryBehavior
    {
        ...
        {
            JObject jtoken1 = JObject.FromObject(new
                {
                    Title = "Name1",
                    SomeObject = new
                        {
            ...
            JObject compareResult = JObject.FromObject(new
                {
                    Title = "Name1",
                    SomeObject = new
                        {
        ...
        public void ShouldGetConditionItemsFromSyntaxTree()
        {
            ...
            Criteria[] syntaxItems = syntaxTree.GetConditionCriteria().ToArray();
        ...
        public void ShouldGetFromItemFromSyntaxTree()
        {
            ...
            var syntaxTree = new QuerySyntaxTree(_jsonQuery);
            ReferencedObject fromItem = syntaxTree.GetFrom();
        ...
        public void ShouldGetProjectionItemsFromSyntaxTree()
        {
            ...
            var syntaxTree = new QuerySyntaxTree(_jsonQuery);
            ProjectionObject[] syntaxItems = syntaxTree.GetProjectionObjects().ToArray();
        ...
        public void ShouldGetQueryResult()
        {
            ...
            JObject jsonQuery = JObject.FromObject(new
                {
                    From = new
                        {
                            Index = "Document",
            ...
            JArray result =
                new JsonQueryExecutor(new ElasticFactory(new RoutingFactoryBase()), _filterFactory,
                                      AuthorizationStorageExtensions.AnonimousUser).ExecuteQuery(jsonQuery);
        ...
        public void ShouldGetReferenceItemsFromSyntaxTree()
        {
            ...
            var syntaxTree = new QuerySyntaxTree(_jsonQuery);
            ReferencedObject[] syntaxItems = syntaxTree.GetReferenceObjects().ToArray();
        ...
        {
            JObject jtoken = JObject.FromObject(new
                {
                    Title = "Name2",
                    SomeObject = new
                        {
            ...
            JObject compareToken = JObject.FromObject(new
                {
                    Title = "Name2",
                    SomeObject = new
                        {
        ...
        public void ShouldLoadRefFieldsByCollectionField()
        {
            ...
            var referenceBuilder = new ReferenceBuilder(new ElasticFactory(new RoutingFactoryBase()),
                                                        AuthorizationStorageExtensions.AnonimousUser);
            referenceBuilder.FillReference(_selectingJson, references.ToArray(), new List<WhereObject>(),
                                           new NestFilterBuilder());
        ...
        public void ShouldRemoveUnsatisfiedItem()
        {
            ...
            JObject compareToken2 = JObject.FromObject(new
                {
                    Title = "Name2"
                });
