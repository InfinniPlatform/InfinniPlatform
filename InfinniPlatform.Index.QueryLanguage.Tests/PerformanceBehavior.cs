...
namespace InfinniPlatform.Index.QueryLanguage.Tests
{
    ...
    public sealed class PerformanceBehavior
    {
        ...
        private List<JObject> CreateTestData(int countObjects)
        {
            ...
            JObject config = CreateJConfiguration();
        ...
        public void ShouldMakeSelectQueryFromObjectsNoLongerThanOneMicrosecond(int countObjects,
                                                                               double resultMilliseconds)
        {
            //Given
            List<JObject> listQuery = CreateTestData(countObjects);
        ...
        public void ShouldMakeFullQueryWithoutIndexingNoLongerThanTwoMicroseconds(int countObjects,
                                                                                  double resultMilliseconds)
        {
            //Given
