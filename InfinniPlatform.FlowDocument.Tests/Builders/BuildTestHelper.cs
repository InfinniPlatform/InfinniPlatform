...
namespace InfinniPlatform.FlowDocument.Tests.Builders
{
    internal static class BuildTestHelper
    {
        ...
        public static PrintElementSection BuildSection(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
            return BuildElement<PrintElementSection>("Section", elementMetadata, elementContext);
        }

        public static PrintElementParagraph BuildParagraph(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
            return BuildElement<PrintElementParagraph>("Paragraph", elementMetadata, elementContext);
        }

        public static PrintElementList BuildList(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
            return BuildElement<PrintElementList>("List", elementMetadata, elementContext);
        }

        public static PrintElementTable BuildTable(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
            return BuildElement<PrintElementTable>("Table", elementMetadata, elementContext);
        }

        public static PrintElementBlock BuildLine(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
            return BuildElement<PrintElementBlock>("Line", elementMetadata, elementContext);
        }

        public static PrintElementBlock BuildPageBreak(object elementMetadata,
            Action<PrintElementBuildContext> elementContext = null)
        {
