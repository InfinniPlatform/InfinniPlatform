...
namespace InfinniPlatform.FlowDocument.Tests.PrintView
{
    ...
    public sealed class FlowDocumentPrintViewBuilderTest
    {
        ...
        private static dynamic CreateTestPrintView()
        {
            ...
            printView.Blocks.Add(
                CreateParagraph(
                    CreateBold(
                        CreateRun(
                            "Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text. Bold text."))));
            printView.Blocks.Add(
                CreateParagraph(
                    CreateItalic(
                        CreateRun(
                            "Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text. Italic text."))));
            printView.Blocks.Add(
                CreateParagraph(
                    CreateUnderline(
                        CreateRun(
                            "Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text. Underline text."))));
            printView.Blocks.Add(
                CreateParagraph(
                    CreateHyperlink(
                        CreateRun(
                            "Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text. Hyperlink text."))));
            printView.Blocks.Add(
                CreateParagraph(
                    CreateBold(
                        CreateItalic(
                            CreateUnderline(
                                CreateHyperlink(
                                    CreateRun(
                                        "Bold & Italic & Underline & Hyperlink text. Bold & Italic & Underline & Hyperlink text. Bold & Italic & Underline & Hyperlink text. Bold & Italic & Underline & Hyperlink text.")))))));
            printView.Blocks.Add(
                CreateParagraph(
                    CreateRun(
                        "Before line break. Before line break. Before line break. Before line break. Before line break. Before line break. Before line break. Before line break."),
                    CreateLineBreak(), CreateRun("After line break.")));
            printView.Blocks.Add(
                CreateParagraph(CreateSpan(CreateRun("Span text. "), CreateBold(CreateRun("Span text. ")),
                    CreateItalic(CreateRun("Span text. ")), CreateUnderline(CreateRun("Span text.")), CreateRun(" "),
                    CreateHyperlink(CreateRun("Span text. ")))));
            printView.Blocks.Add(CreateParagraph(CreateImage("Rotate0"), CreateImage("Rotate90"),
                CreateImage("Rotate180"), CreateImage("Rotate270")));
            printView.Blocks.Add(CreateParagraph(CreateBarcodeEan13("Rotate0"), CreateBarcodeEan13("Rotate90"),
                CreateBarcodeEan13("Rotate180"), CreateBarcodeEan13("Rotate270")));
            printView.Blocks.Add(CreateParagraph(CreateBarcodeQr("Rotate0"), CreateBarcodeQr("Rotate90"),
                CreateBarcodeQr("Rotate180"), CreateBarcodeQr("Rotate270")));
            printView.Blocks.Add(CreateSection(CreateParagraph(CreateRun("Before page break.")), CreatePageBreak(),
                CreateParagraph(CreateRun("After page break."))));
            ...
            printView.Blocks.Add(CreateSection(CreateParagraph(CreateRun("Before line.")), CreateLine(),
                CreateParagraph(CreateRun("After line."))));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Arial 10pt. "),
                CreateRunWithFont("Arial 15pt. ", "Arial", 15), CreateRunWithFont("Arial 20pt. ", "Arial", 20)));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Tahoma 10pt. ", "Tahoma"),
                CreateRunWithFont("Tahoma 15pt. ", "Tahoma", 15), CreateRunWithFont("Tahoma 20pt. ", "Tahoma", 20)));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Courier New 10pt. ", "Courier New"),
                CreateRunWithFont("Courier New 15pt. ", "Courier New", 15),
                CreateRunWithFont("Courier New 20pt. ", "Courier New", 20)));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Normal. ", "Arial", 10, style: "Normal"),
                CreateRunWithFont("Italic. ", "Arial", 10, style: "Italic"),
                CreateRunWithFont("Oblique. ", "Arial", 10, style: "Oblique")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Normal. ", "Arial", 10, stretch: "Normal"),
                CreateRunWithFont("UltraCondensed. ", "Arial", 10, stretch: "UltraCondensed"),
                CreateRunWithFont("ExtraCondensed. ", "Arial", 10, stretch: "ExtraCondensed"),
                CreateRunWithFont("Condensed. ", "Arial", 10, stretch: "Condensed"),
                CreateRunWithFont("SemiCondensed. ", "Arial", 10, stretch: "SemiCondensed"),
                CreateRunWithFont("SemiExpanded. ", "Arial", 10, stretch: "SemiExpanded"),
                CreateRunWithFont("Expanded. ", "Arial", 10, stretch: "Expanded"),
                CreateRunWithFont("ExtraExpanded. ", "Arial", 10, stretch: "ExtraExpanded"),
                CreateRunWithFont("UltraExpanded. ", "Arial", 10, stretch: "UltraExpanded")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Normal. ", "Arial", 10, weight: "Normal"),
                CreateRunWithFont("UltraLight. ", "Arial", 10, weight: "UltraLight"),
                CreateRunWithFont("ExtraLight. ", "Arial", 10, weight: "ExtraLight"),
                CreateRunWithFont("Light. ", "Arial", 10, weight: "Light"),
                CreateRunWithFont("Medium. ", "Arial", 10, weight: "Medium"),
                CreateRunWithFont("SemiBold. ", "Arial", 10, weight: "SemiBold"),
                CreateRunWithFont("Bold. ", "Arial", 10, weight: "Bold"),
                CreateRunWithFont("ExtraBold. ", "Arial", 10, weight: "ExtraBold"),
                CreateRunWithFont("UltraBold. ", "Arial", 10, weight: "UltraBold")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("Normal. ", "Arial", 10, variant: "Normal"),
                CreateRunWithFont("Subscript. ", "Arial", 10, variant: "Subscript"),
                CreateRunWithFont("Superscript. ", "Arial", 10, variant: "Superscript")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("H"),
                CreateRunWithFont("2", "Palatino Linotype", variant: "Subscript"), CreateRunWithFont("O")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("C"),
                CreateRunWithFont("2", "Palatino Linotype", variant: "Subscript"), CreateRunWithFont("H"),
                CreateRunWithFont("5", "Palatino Linotype", variant: "Subscript"), CreateRunWithFont("OH")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithFont("a"),
                CreateRunWithFont("2", "Palatino Linotype", variant: "Superscript"), CreateRunWithFont(" + b"),
                CreateRunWithFont("2", "Palatino Linotype", variant: "Superscript"), CreateRunWithFont(" = c"),
                CreateRunWithFont("2", "Palatino Linotype", variant: "Superscript")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithTextDecoration("Normal. ", "Normal"),
                CreateRunWithTextDecoration("Overline. ", "Overline"),
                CreateRunWithTextDecoration("Strikethrough. ", "Strikethrough"),
                CreateRunWithTextDecoration("Underline. ", "Underline")));
            printView.Blocks.Add(CreateParagraph(CreateRunWithColor("Green foreground. ", "Green", null),
                CreateRunWithColor("Red background. ", null, "Red"),
                CreateRunWithColor("Green foreground & Red background. ", "Green", "Red")));
            printView.Blocks.Add(CreatePageBreak());
            printView.Blocks.Add(CreateParagraphWithTextAlignment("Left",
                CreateRun(
                    "Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text. Left text.")));
            printView.Blocks.Add(CreateParagraphWithTextAlignment("Right",
                CreateRun(
                    "Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text. Right text.")));
            printView.Blocks.Add(CreateParagraphWithTextAlignment("Center",
                CreateRun(
                    "Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text. Center text.")));
            printView.Blocks.Add(CreateParagraphWithTextAlignment("Justify",
                CreateRun(
                    "Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text. Justify text.")));
            printView.Blocks.Add(CreateParagraphWithTextCase("SentenceCase", CreateRun("sentencecase"),
                CreateRun(" sentencecase.")));
            printView.Blocks.Add(CreateParagraphWithTextCase("Lowercase", CreateRun("LOWERCASE "),
                CreateRun(" LOWERCASE.")));
            printView.Blocks.Add(CreateParagraphWithTextCase("Uppercase", CreateRun("uppercase "),
                CreateRun(" uppercase.")));
            printView.Blocks.Add(CreateParagraphWithTextCase("ToggleCase", CreateRun("Togglecase "),
                CreateRun(" tOGGLECASE.")));
            printView.Blocks.Add(CreateSectionWithBorder(new Thickness(15), new Thickness(20), new Thickness(4), "Red",
                "Green",
                CreateSectionWithBorder(new Thickness(5), new Thickness(10), new Thickness(2), "Blue", "Yellow",
                    CreateParagraph(CreateRun("Section & Margin & Padding & Border & Background")))));
        ...
        private static dynamic CreateSectionWithBorder(Thickness margin, Thickness padding, Thickness border,
            string borderBrush, string background, params dynamic[] blocks)
        {
        ...
        private static dynamic CreateRunWithFont(string text, string family = "Arial", double size = 10,
            string sizeUnit = "pt", string style = null, string stretch = null, string weight = null,
            string variant = null)
        {
