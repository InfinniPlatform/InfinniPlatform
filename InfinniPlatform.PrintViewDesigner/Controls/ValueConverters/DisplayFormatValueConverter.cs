...
namespace InfinniPlatform.PrintViewDesigner.Controls.ValueConverters
{
	...
	sealed class DisplayFormatValueConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			...
			if (editValue != null)
			{
				...
				{
					result = string.Format(Resources.BooleanFormat, CastToString(editValue.BooleanFormat.FalseText, bool.FalseString), CastToString(editValue.BooleanFormat.TrueText, bool.TrueString));
				}
