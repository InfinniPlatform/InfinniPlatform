...
namespace InfinniPlatform.PrintViewDesigner.Controls.PrintElementProperty
{
	...
	public sealed partial class PrintElementPropertyControl : UserControl
	{
		...
		public static readonly DependencyProperty PrintViewProperty = DependencyProperty.Register("PrintView", typeof(object), typeof(PrintElementPropertyControl));
		...
		public static readonly DependencyProperty SelectedElementProperty = DependencyProperty.Register("SelectedElement", typeof(PrintElementNode), typeof(PrintElementPropertyControl), new FrameworkPropertyMetadata(OnSelectedElementChanged));
		...
		public static readonly RoutedEvent ElementMetadataChangedEvent = EventManager.RegisterRoutedEvent("ElementMetadataChanged", RoutingStrategy.Bubble, typeof(PropertyValueChangedEventHandler), typeof(PrintElementPropertyControl));
