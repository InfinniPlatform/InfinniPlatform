...
namespace InfinniPlatform.PrintViewDesigner.Controls.PrintElementProperty
{
    ...
    internal sealed class PrintElementPropertyEditorFactory
    {
        ...
        private void AddListProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyInteger(listCategory.Properties, propertyParent, "StartIndex", Resources.ListStartIndexProperty,
                1);
            AddProperty<PropertyEditorListMarkerStyle>(listCategory.Properties, propertyParent, "MarkerStyle",
                Resources.ListMarkerStyleProperty);
            AddProperty<PropertyEditorMarkerOffsetSize>(listCategory.Properties, propertyParent, "",
                Resources.ListMarkerOffset);
        }
        ...
        private static void AddTableColumnProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyString(commonCategory.Properties, propertyParent, "Name", Resources.NameProperty,
                @"[a-zA-Z_]+[a-zA-Z_0-9]*");

            // Layout
            var layoutCategory = AddCategory(properties, Resources.LayoutCategory);
            AddProperty<PropertyEditorColumnSize>(layoutCategory.Properties, propertyParent, "",
                Resources.ColumnSizeProperty);
        }
        ...
        private void AddTableCellProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyInteger(layoutCategory.Properties, propertyParent, "ColumnSpan",
                Resources.TableCellColumnSpanProperty, 1);
            AddPropertyInteger(layoutCategory.Properties, propertyParent, "RowSpan", Resources.TableCellRowSpanProperty,
                1);
        ...
        private void AddHyperlinkProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyDisplayFormat(dataCategory.Properties, propertyParent, "SourceFormat",
                Resources.HyperlinkSourceFormatProperty);
        ...
        private void AddRunProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddProperty<PropertyEditorLongString>(dataCategory.Properties, propertyParent, "Text",
                Resources.RunTextProperty);
        }
        ...
        private static void AddImageProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            // Data
            var dataCategory = AddCategory(properties, Resources.DataCategory);
            AddProperty<PropertyEditorImage>(dataCategory.Properties, propertyParent, "Data",
                Resources.ImageDataProperty);
            ...
            AddProperty<PropertyEditorImageStretch>(imageCategory.Properties, propertyParent, "Stretch",
                Resources.ImageStretchProperty);
        }
        ...
        private static void AddBarcodeEan13Properties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyBoolean(barcodeCategory.Properties, propertyParent, "CalcCheckSum",
                Resources.BarcodeEan13CalcCheckSumProperty);
            AddPropertyDouble(barcodeCategory.Properties, propertyParent, "WideBarRatio",
                Resources.BarcodeEan13WideBarRatioProperty, 2);
            AddPropertyRotation(barcodeCategory.Properties, propertyParent, "Rotation",
                Resources.BarcodeEan13RotationProperty);
        }
        ...
        private static void AddBarcodeQrProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            // Barcode
            var barcodeCategory = AddCategory(properties, Resources.BarcodeCategory);
            AddProperty<PropertyEditorBarcodeQrErrorCorrection>(barcodeCategory.Properties, propertyParent,
                "ErrorCorrection", Resources.BarcodeQrErrorCorrectionProperty);
            AddPropertyRotation(barcodeCategory.Properties, propertyParent, "Rotation",
                Resources.BarcodeQrRotationProperty);
        }
        ...
        private void AddInlineProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            // Text
            var textCategory = AddCategory(properties, Resources.TextCategory);
            AddPropertyTextDecoration(textCategory.Properties, propertyParent, "TextDecoration",
                Resources.TextDecorationProperty);
        }
        ...
        private void AddPrintViewProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            AddPropertyLongString(commonCategory.Properties, propertyParent, "Description",
                Resources.DescriptionProperty);
            AddProperty<PropertyEditorViewType>(commonCategory.Properties, propertyParent, "ViewType",
                Resources.ViewTypeProperty);
        ...
        private static void AddCommonProperties(PropertyCollection properties, string propertyParent)
        {
            ...
            // Data
            var dataCategory = AddCategory(properties, Resources.DataCategory);
            AddProperty<PropertyEditorVisibility>(dataCategory.Properties, propertyParent, "Visibility",
                Resources.VisibilityProperty);
            AddPropertyString(dataCategory.Properties, propertyParent, "Source", Resources.SourceProperty,
                @"((\$)|([0-9]+)|([a-zA-Z_]+[a-zA-Z_0-9]*)){1}(\.((\$)|([0-9]+)|([a-zA-Z_]+[a-zA-Z_0-9]*)){1})*");
        ...
        private static void AddPropertyBorder(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption)
        {
            AddProperty<PropertyEditorBorder>(properties, propertyParent, propertyName, propertyCaption);
        }

        private static void AddPropertySize(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption)
        {
        ...
        private static void AddPropertyFont(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption)
        {
            AddProperty<PropertyEditorFont>(properties, propertyParent, propertyName, propertyCaption);
        }

        private static void AddPropertyRotation(PropertyCollection properties, string propertyParent,
            string propertyName, string propertyCaption)
        {
            AddProperty<PropertyEditorRotation>(properties, propertyParent, propertyName, propertyCaption);
        }

        private static void AddPropertyTextCase(PropertyCollection properties, string propertyParent,
            string propertyName, string propertyCaption)
        {
            AddProperty<PropertyEditorTextCase>(properties, propertyParent, propertyName, propertyCaption);
        }

        private static void AddPropertyTextDecoration(PropertyCollection properties, string propertyParent,
            string propertyName, string propertyCaption)
        {
        ...
        private void AddPropertyStyle(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption)
        {
            var propertyEditor = AddProperty<PropertyEditorStyle>(properties, propertyParent, propertyName,
                propertyCaption);
        ...
        private static void AddPropertyString(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption, string propertyRegex = ".*")
        {
            var propertyEditor = AddProperty<PropertyEditorString>(properties, propertyParent, propertyName,
                propertyCaption);
            propertyEditor.Regex = propertyRegex;
        }

        private static void AddPropertyLongString(PropertyCollection properties, string propertyParent,
            string propertyName, string propertyCaption)
        {
            AddProperty<PropertyEditorLongString>(properties, propertyParent, propertyName, propertyCaption);
        }

        private static void AddPropertyDouble(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption, double? minValue = null, double? maxValue = null)
        {
            var propertyEditor = AddProperty<PropertyEditorDouble>(properties, propertyParent, propertyName,
                propertyCaption);
            propertyEditor.MinValue = minValue;
            propertyEditor.MaxValue = maxValue;
        }

        private static void AddPropertyInteger(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption, int? minValue = null, int? maxValue = null)
        {
            var propertyEditor = AddProperty<PropertyEditorInteger>(properties, propertyParent, propertyName,
                propertyCaption);
            propertyEditor.MinValue = minValue;
            propertyEditor.MaxValue = maxValue;
        }

        private static void AddPropertyBoolean(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption)
        {
        ...
        private static T AddProperty<T>(PropertyCollection properties, string propertyParent, string propertyName,
            string propertyCaption) where T : PropertyEditorBase, new()
        {
