...
namespace InfinniPlatform.PrintViewDesigner.Controls.PrintElementProperty
{
	...
	/// </summary>
	sealed class PrintElementPropertyEditorFactory
	{
		...
		private void AddPropertyStyle(PropertyCollection properties, string propertyParent, string propertyName, string propertyCaption)
		{
		...
		private static PropertyEditorBase AddCategory(PropertyCollection properties, string categoryCaption)
		{
			...
			return (propertyDefinition == null) ? AddProperty<PropertyEditorObject>(properties, null, null, categoryCaption) : propertyDefinition.Editor;
		}
		...
		private static T AddProperty<T>(PropertyCollection properties, string propertyParent, string propertyName, string propertyCaption) where T : PropertyEditorBase, new()
		{
			...
			properties.Add(new PropertyDefinition { Name = propertyPath, Caption = propertyCaption ?? propertyName, Editor = propertyEditor });
