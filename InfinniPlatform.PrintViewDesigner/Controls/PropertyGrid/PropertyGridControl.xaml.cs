...
namespace InfinniPlatform.PrintViewDesigner.Controls.PropertyGrid
{
	...
	public sealed partial class PropertyGridControl : UserControl
	{
		...
		public static readonly DependencyProperty PropertiesProperty = DependencyProperty.Register("Properties", typeof(PropertyCollection), typeof(PropertyGridControl));
		...
		public static readonly DependencyProperty EditValueProperty = DependencyProperty.Register("EditValue", typeof(object), typeof(PropertyGridControl), new FrameworkPropertyMetadata(OnEditValueChanged));
		...
		public static readonly RoutedEvent EditValueChangedEvent = EventManager.RegisterRoutedEvent("EditValueChanged", RoutingStrategy.Bubble, typeof(PropertyValueChangedEventHandler), typeof(PropertyGridControl));
