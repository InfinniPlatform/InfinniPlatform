...
namespace InfinniPlatform.PrintViewDesigner.Controls.PropertyGrid
{
	...
	public class PropertyEditorBase : UserControl
	{
		...
		public static readonly DependencyProperty PropertyProperty = DependencyProperty.Register("Property", typeof(string), typeof(PropertyEditorBase));
		...
		public static readonly DependencyProperty PropertiesProperty = DependencyProperty.Register("Properties", typeof(PropertyCollection), typeof(PropertyEditorBase), new PropertyMetadata(OnPropertiesChangedHandler));
		...
		public static readonly DependencyProperty EditValueProperty = DependencyProperty.Register("EditValue", typeof(object), typeof(PropertyEditorBase), new FrameworkPropertyMetadata(OnEditValueChanged));
		...
		public static readonly RoutedEvent EditValueChangedEvent = EventManager.RegisterRoutedEvent("EditValueChanged", RoutingStrategy.Bubble, typeof(PropertyValueChangedEventHandler), typeof(PropertyEditorBase));
