    ...
    public sealed partial class PrintViewViewerControl : UserControl
    {
        ...
        private void OnInspectElementMetadata(object sender, RoutedEventArgs e)
        {
            ...
            if (position != null && position.Parent != null)
            {
                ...
                if (elementMetadataMap != null)
                {
                    ...
                    {
                        RaiseEvent(new PropertyValueChangedEventArgs(InspectElementMetadataEvent, null, null,
                            elementMetadata));
                    }
                }
            }
        ...
        public void Preview()
        {
            ...
            if (printView != null)
            {
                ...
                {
                    MessageBox.Show(error.Message, AppResources.PrintViewDesignerName, MessageBoxButton.OK,
        ...
        public static readonly DependencyProperty PrintViewProperty = DependencyProperty.Register("PrintView",
            typeof (object), typeof (PrintViewViewerControl), new FrameworkPropertyMetadata(OnPrintViewChanged));

        // HighlightElement

        public static readonly DependencyProperty HighlightElementProperty =
            DependencyProperty.Register("HighlightElement", typeof (PrintElementNode), typeof (PrintViewViewerControl),
                new FrameworkPropertyMetadata(OnHighlightElementChanged));

        // InspectElementMetadata

        public static readonly RoutedEvent InspectElementMetadataEvent =
            EventManager.RegisterRoutedEvent("InspectElementMetadata", RoutingStrategy.Bubble,
                typeof (PropertyValueChangedEventHandler), typeof (PrintViewViewerControl));
    }
}