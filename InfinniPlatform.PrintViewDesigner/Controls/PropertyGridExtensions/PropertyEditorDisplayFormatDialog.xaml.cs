    ...
    public partial class PropertyEditorDisplayFormatDialog : DXWindow
    {
        ...
        private dynamic GetEditValue()
        {
            ...
            if (BooleanFormatTab.Equals(FormatTabControl.SelectedTabItem))
            {
                ...
                editValue.BooleanFormat.FalseText = BooleanFormatFalseTextEditor.EditValue ??
                                                    BooleanFormatFalseTextEditor.NullValue;
                editValue.BooleanFormat.TrueText = BooleanFormatTrueTextEditor.EditValue ??
                                                   BooleanFormatTrueTextEditor.NullValue;
            }
