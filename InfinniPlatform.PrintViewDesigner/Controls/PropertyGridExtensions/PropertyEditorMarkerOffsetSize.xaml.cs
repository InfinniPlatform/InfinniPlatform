...
namespace InfinniPlatform.PrintViewDesigner.Controls.PropertyGridExtensions
{
    public partial class PropertyEditorMarkerOffsetSize : PropertyEditorBase
    {
        ...
        protected override void OnPropertiesChanged(PropertyCollection properties)
        {
            ...
            if (properties != null)
            {
                AddProperty("MarkerOffsetSize", AppResources.ListMarkerOffsetSizeProperty, MarkerOffsetSizeEditor,
                    Visibility.Collapsed);
                AddProperty("MarkerOffsetSizeUnit", AppResources.ListMarkerOffsetSizeUnitProperty,
                    MarkerOffsetSizeUnitEditor, Visibility.Collapsed);
            }
        }
    }
}