...
{
	sealed class PrintViewStylesNodeFactory : IPrintElementNodeFactory
	{
		...
		public void Create(PrintElementNodeBuilder builder, ICollection<PrintElementNode> elements, PrintElementNode elementNode)
		{
			...
			elementNode.InsertChild = BuildHelper.InsertChildToCollection(builder, elements, elementNode, "Styles", false);
