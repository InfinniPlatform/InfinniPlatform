...
{
	sealed class PrintElementNodeBuilder
	{
		...
		public void BuildElement(ICollection<PrintElementNode> elements, PrintElementNode elementParent, dynamic elementMetadata)
		{
		...
		public void BuildElement(ICollection<PrintElementNode> elements, PrintElementNode elementParent, dynamic elementMetadata, string elementType)
		{
		...
		class PrintElementNodeFactoryInfo
		{
