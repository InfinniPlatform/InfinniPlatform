...
{
	sealed class PrintElementTableColumnCellTemplateNodeFactory : IPrintElementNodeFactory
	{
		...
		public void Create(PrintElementNodeBuilder builder, ICollection<PrintElementNode> elements, PrintElementNode elementNode)
		{
			...
			elementNode.InsertChild = BuildHelper.InsertChildToContainer(builder, elements, elementNode, "CellTemplate", false);

			elementNode.CanDeleteChild = BuildHelper.CanDeleteChild(elementNode);
			elementNode.DeleteChild = BuildHelper.DeleteChildFromContainer(elements, elementNode, "CellTemplate", false);
