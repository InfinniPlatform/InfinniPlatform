...
{
	sealed class PrintElementTableRowsNodeFactory : IPrintElementNodeFactory
	{
		...
		private static Func<PrintElementNode, bool> InsertTableRow(PrintElementNodeBuilder builder, ICollection<PrintElementNode> elements, PrintElementNode parentElementNode)
		{
			...
			var insertChildFunc = BuildHelper.InsertChildToCollection(builder, elements, parentElementNode, "Rows", false);
