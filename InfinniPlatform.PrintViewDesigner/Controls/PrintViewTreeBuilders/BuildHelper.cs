...
namespace InfinniPlatform.PrintViewDesigner.Controls.PrintViewTreeBuilders
{
	...
	{
		public static readonly string[] BlockTypes = { "Section", "Paragraph", "List", "Table", "Line", "PageBreak" };
		public static readonly string[] InlineTypes = { "Span", "Bold", "Italic", "Underline", "Hyperlink", "LineBreak", "Run", "Image", "BarcodeEan13", "BarcodeQr" };
		...
		public static Func<PrintElementNode, bool> InsertChildToCollection(PrintElementNodeBuilder builder, ICollection<PrintElementNode> elements, PrintElementNode parentElementNode, string childElementCollection, bool wrapElementMetadata = true)
		{
			return childElementNode =>
				   {
					   if (parentElementNode.CanInsertChild.TryInvoke(childElementNode))
					   {
						   ...
						   childElements.AddItem(wrapElementMetadata ? WrapElementMetadata(childElementNode.ElementType, newChildElementMetadata) : newChildElementMetadata);
		...
		public static Func<PrintElementNode, bool> InsertChildToContainer(PrintElementNodeBuilder builder, ICollection<PrintElementNode> elements, PrintElementNode parentElementNode, string childElementContainer, bool wrapElementMetadata = true)
		{
			return childElementNode =>
				   {
					   if (parentElementNode.CanInsertChild.TryInvoke(childElementNode))
					   {
						   ...
						   if (oldChildElement == null || Helpers.AcceptQuestionMessage(Resources.ReplaceElementQuestion, parentElementNode, childElementNode))
						   {
							   ...
							   parentElementNode.ElementMetadata[childElementContainer] = wrapElementMetadata ? WrapElementMetadata(childElementNode.ElementType, newChildElementMetadata) : newChildElementMetadata;
		...
		public static Func<PrintElementNode, bool, bool> DeleteChildFromCollection(ICollection<PrintElementNode> elements, PrintElementNode parentElementNode, string childElementCollection, bool wrapElementMetadata = true)
		{
		...
		public static Func<PrintElementNode, bool, bool> DeleteChildFromContainer(ICollection<PrintElementNode> elements, PrintElementNode parentElementNode, string childElementContainer, bool wrapElementMetadata = true)
		{
			return (childElementNode, accept) =>
				   {
					   if (parentElementNode.CanDeleteChild.TryInvoke(childElementNode, accept))
		...
		public static Func<PrintElementNode, int, bool> MoveChildInCollection(PrintElementNode parentElementNode, string childElementCollection, bool wrapElementMetadata = true)
		{
			...
			return () =>
				   {
					   if (parentElementNode.CanPaste.TryInvoke())
					   {
						   ...
						   if (entry != null)
						   {
							   ...
							   {
								   Helpers.ShowWarningMessage(Resources.CannotInsertParentIntoChild, parentElementNode, childElementNode);
								   return false;
							   }
							   ...
							   if (!parentElementNode.CanInsertChild.TryInvoke(childElementNode))
							   {
								   Helpers.ShowWarningMessage(Resources.CannotInsertChildElement, childElementNode, parentElementNode);
								   return false;
							   }
		...
		private static void ProcessChildElement(IList childElements, PrintElementNode childElementNode, Action<object> action, bool wrapElementMetadata)
		{
			if (childElements != null)
			{
				...
				{
					if ((wrapElementMetadata && (element[childElementType] == childElementMetadata)) || (!wrapElementMetadata && (element == childElementMetadata)))
					{
						action(element);
						break;
					}
