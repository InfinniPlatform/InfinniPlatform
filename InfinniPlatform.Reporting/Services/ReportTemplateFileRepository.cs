...
namespace InfinniPlatform.Reporting.Services
{
    ...
    /// </summary>
    internal sealed class ReportTemplateFileRepository : IReportTemplateRepository
    {
        ...
        public ReportTemplate GetReportTemplate(string templateId)
        {
            ...
            using (var reportTemplateData = File.OpenRead(Path.Combine(_reportBaseDirectory, templateId)))
            {
