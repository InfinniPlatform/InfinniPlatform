...
{
    internal sealed class PrintElementHyperlinkFactory : IPrintElementFactory
    {
        ...
        private static void ApplyReference(Hyperlink element, PrintElementBuildContext buildContext,
            dynamic elementMetadata)
        {
            string referenceSting = BuildHelper.FormatValue(buildContext, elementMetadata.Reference,
                elementMetadata.SourceFormat);
